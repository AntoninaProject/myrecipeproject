...
(jQuery.easing.jswing = jQuery.easing.swing),
  jQuery.extend(jQuery.easing, {
    ...
    easeOutElastic: function (t, e, i, n, o) {
      ...
      return (
        s * Math.pow(2, -10 * e) * Math.sin(((e * o - a) * (2 * Math.PI)) / r) +
        n +
        i
      );
    },
    ...
    easeInBack: function (t, e, i, n, o, a) {
      return (
        null == a && (a = 1.70158), n * (e /= o) * e * ((a + 1) * e - a) + i
      );
    },
    ...
    easeInOutBack: function (t, e, i, n, o, a) {
      return (
        null == a && (a = 1.70158),
        (e /= o / 2) < 1
          ? (n / 2) * (e * e * ((1 + (a *= 1.525)) * e - a)) + i
          : (n / 2) * ((e -= 2) * e * ((1 + (a *= 1.525)) * e + a) + 2) + i
      );
    },
        ...
        return (function (t, e, i, n) {
          ...
          function s(t, e) {
            ...
            return (
              ...
              !1 === i &&
                (i = g.Easings[g.defaults.easing] ? g.defaults.easing : v),
              i
            );
          }
          function l(t) {
            if (t) {
              ...
              for (var o = 0; i > o; o++)
                if (g.State.calls[o]) {
                  ...
                  for (
                    var v = Math.min((e - h) / d.duration, 1),
                      b = 0,
                      x = s.length;
                    x > b;
                    b++
                    ...
                    if (a(C)) {
                      ...
                      for (var M in (d.visibility !== n &&
                        "hidden" !== d.visibility &&
                        y.setPropertyValue(C, "visibility", d.visibility),
                      k))
                        if ("element" !== M) {
                          var T,
                            I = k[M],
                            O = p.isString(I.easing)
                              ? g.Easings[I.easing]
                              : I.easing;
                          if (1 === v) T = I.endValue;
                          else {
                          ...
                          if (((I.currentValue = T), "tween" === M)) m = T;
                            ...
                            if (y.Hooks.registered[M]) {
                              var A = y.Hooks.getRoot(M),
                                D = a(C).rootPropertyValueCache[A];
                              D && (I.rootPropertyValue = D);
                            }
                            var _ = y.setPropertyValue(
                              C,
                              M,
                              I.currentValue +
                                (0 === parseFloat(T) ? "" : I.unitType),
                              I.rootPropertyValue,
                              I.scrollData
                            );
                            y.Hooks.registered[M] &&
                              (a(C).rootPropertyValueCache[A] = y.Normalizations
                                .registered[A]
                                ? y.Normalizations.registered[A](
                                    "extract",
                                    null,
                                    _[1]
                                  )
                      ...
                      d.mobileHA &&
                        ...
                        ((a(C).transformCache.translate3d = "(0px, 0px, 0px)"),
                        (S = !0)),
                        S && y.flushTransformCache(C);
                    }
                  }
                  d.display !== n &&
                    "none" !== d.display &&
            ...
            for (
              ...
              if (
                (e ||
                  r.loop ||
                  ("none" === r.display &&
                    y.setPropertyValue(h, "display", r.display),
                  "hidden" === r.visibility &&
                    y.setPropertyValue(h, "visibility", r.visibility)),
                !0 !== r.loop &&
                  (u.queue(h)[1] === n ||
                    !/\.velocityQueueEntryFlag/i.test(u.queue(h)[1])) &&
                  a(h))
              ) {
                ...
                u.each(y.Lists.transforms3D, function (t, e) {
                  ...
                  a(h).transformCache[e] !== n &&
                    new RegExp("^\\(" + i + "[^.]").test(o) &&
                    ((p = !0), delete a(h).transformCache[e]);
                }),
                  r.mobileHA &&
                    ((p = !0), delete a(h).transformCache.translate3d),
                  p && y.flushTransformCache(h),
              ...
              s && !0 !== r.loop && s(o),
                a(h) &&
                  ...
                  g(h, "reverse", { loop: !0, delay: r.delay })),
          ...
          if (!(7 >= d)) {
                  ...
                  if (d)
                    for (i in y.Hooks.templates) {
                      ...
                      "Color" === o[0] &&
                        (o.push(o.shift()),
                        a.push(a.shift()),
                        (y.Hooks.templates[i] = [o.join(" "), a.join(" ")]));
                    }
                  for (i in y.Hooks.templates)
                ...
                injectValue: function (t, e, i) {
                  ...
                  if (n) {
                    var o,
                      ...
                      r = n[1];
                    return (
                      ((o = (i = y.Hooks.cleanRootPropertyValue(a, i))
                        .toString()
                        .match(y.RegEx.valueSplit))[r] = e),
                      o.join(" ")
                    );
                  }
                  return i;
                ...
                prefixCheck: function (t) {
                  ...
                  for (
                    ...
                    if (
                      ...
                      p.isString(g.State.prefixElement.style[o]))
                    )
              ...
              getPropertyValue: function (t, i, o, r) {
                ...
                if (y.Hooks.registered[i]) {
                  var c = i,
                    h = y.Hooks.getRoot(c);
                  o === n &&
                    (o = y.getPropertyValue(t, y.Names.prefixCheck(h)[0])),
                    y.Normalizations.registered[h] &&
                      (o = y.Normalizations.registered[h]("extract", t, o)),
                    (l = y.Hooks.extractValue(c, o));
                } else if (y.Normalizations.registered[i]) {
                  var p, f;
                  "transform" !==
                    (p = y.Normalizations.registered[i]("name", t)) &&
                    ((f = s(t, y.Names.prefixCheck(p)[0])),
                    y.Values.isCSSNullValue(f) &&
                      y.Hooks.templates[i] &&
                      (f = y.Hooks.templates[i][1])),
                    (l = y.Normalizations.registered[i]("extract", t, f));
                }
                if (!/^[\d-]/.test(l))
              ...
              setPropertyValue: function (t, i, n, o, r) {
                ...
                if ("scroll" === i)
                  ...
                  if (y.Hooks.registered[i]) {
                    var l = i,
                      c = y.Hooks.getRoot(i);
                    (o = o || y.getPropertyValue(t, c)),
                      (n = y.Hooks.injectValue(l, n, o)),
                      (i = c);
                  }
                  if (
                    (y.Normalizations.registered[i] &&
                    ...
                    a(t) && a(t).isSVG && y.Names.SVGAttribute(i)
                      ? t.setAttribute(i, n)
                      : (t.style[s] = n);
                  g.debug >= 2 &&
              ...
              flushTransformCache: function (t) {
                ...
                if (
                  ...
                  u.each(a(t).transformCache, function (e) {
                    return (
                      (o = a(t).transformCache[e]),
                      "transformPerspective" === e
                        ? ((r = o), !0)
                        : (9 === d && "rotateZ" === e && (e = "rotate"),
                          void (i += e + o + " "))
                    );
                  }),
                    r && (i = "perspective" + r + " " + i);
                ...
                return (
                  ...
                  u.each(t, function (t, o) {
                    if ((a(o) === n && g.init(o), i === n))
                      r === n && (r = g.CSS.getPropertyValue(o, e));
                    else {
            ...
            var x = function () {
              ...
              function r() {
                function t(t) {
                  ...
                  function m() {
                    ...
                    if (o && n)
                      ...
                      g.init(c),
                        ...
                        g.CSS.setPropertyValue(c, "position", t.position),
                        g.CSS.setPropertyValue(c, "fontSize", t.fontSize),
                        ...
                        (l.percentToPxWidth = L.lastPercentToPxWidth =
                          (parseFloat(
                            y.getPropertyValue(c, "width", null, !0)
                          ) || 1) / s),
                        (l.percentToPxHeight = L.lastPercentToPxHeight =
                          (parseFloat(
                            y.getPropertyValue(c, "height", null, !0)
                          ) || 1) / s),
                        (l.emToPx = L.lastEmToPx =
                          (parseFloat(y.getPropertyValue(c, "paddingLeft")) ||
                            1) / s),
                    ...
                    return (
                      ...
                      (l.vhToPx = L.vhToPx),
                      g.debug >= 1 &&
                        console.log("Unit ratios: " + JSON.stringify(l), r),
                      l
                    );
                  }
                  if (c.begin && 0 === S)
                  ...
                  if ("scroll" === T) {
                    var x,
                      k,
                      M,
                      O = /^x$/i.test(c.axis) ? "Left" : "Top",
                      P = parseFloat(c.offset) || 0;
                    c.container
                      ? p.isWrapped(c.container) || p.isNode(c.container)
                        ? ((c.container = c.container[0] || c.container),
                          (M =
                            (x = c.container["scroll" + O]) +
                            u(r).position()[O.toLowerCase()] +
                            P))
                        : (c.container = null)
                      : ((x =
                          g.State.scrollAnchor[g.State["scrollProperty" + O]]),
                        (k =
                          g.State.scrollAnchor[
                            g.State[
                      ...
                      g.debug &&
                        console.log("tweensContainer (scroll): ", d.scroll, r);
                  } else if ("reverse" === T) {
                    ...
                    for (var D in A)
                      if ("element" !== D) {
                        var _ = A[D].startValue;
                        (A[D].startValue = A[D].currentValue = A[D].endValue),
                          (A[D].endValue = _),
                          p.isEmptyObject(w) || (A[D].easing = c.easing),
                          g.debug &&
                            console.log(
                    ...
                    for (var E in (a(r).tweensContainer &&
                      !0 === a(r).isAnimating &&
                      (A = a(r).tweensContainer),
                    u.each(b, function (t, e) {
                      if (
                        ...
                        if (y.RegEx.isHex.test(o)) {
                          for (
                            var s = ["Red", "Green", "Blue"],
                              l = y.Values.hexToRgb(o),
                              c = r ? y.Values.hexToRgb(r) : n,
                              u = 0;
                            u < s.length;
                            u++
                          ) {
                    ...
                    b)) {
                      ...
                      if (
                        ...
                        y.Normalizations.registered[N] !== n
                      ) {
                        ((c.display !== n &&
                          null !== c.display &&
                          "none" !== c.display) ||
                          ...
                          0 !== R &&
                          (V = 0),
                          c._cacheValues && A && A[E]
                            ? (V === n && (V = A[E].endValue + A[E].unitType),
                              (z = a(r).rootPropertyValueCache[N]))
                            : y.Hooks.registered[E]
                            ? V === n
                              ? ((z = y.getPropertyValue(r, N)),
                                (V = y.getPropertyValue(r, E, z)))
                              : (z = y.Hooks.templates[N][1])
                            : V === n && (V = y.getPropertyValue(r, E));
                        var H,
                          B,
                          j,
                          Y = !1;
                  ...
                  d.element &&
                    (y.Values.addClass(r, "velocity-animating"),
                    $.push(d),
                    "" === c.queue &&
                      ((a(r).tweensContainer = d), (a(r).opts = c)),
                    (a(r).isAnimating = !0),
                    S === C - 1
                      ? (g.State.calls.push([$, v, c, null, I.resolver]),
                        !1 === g.State.isTicking &&
                ...
                !1 !== g.mock &&
                  ...
                  c.progress &&
                    !p.isFunction(c.progress) &&
                    (c.progress = null),
                  c.complete &&
                    !p.isFunction(c.complete) &&
                    (c.complete = null),
                  c.display !== n &&
                    null !== c.display &&
                  ...
                  (c.mobileHA =
                    c.mobileHA && g.State.isMobile && !g.State.isGingerbread),
                  !1 === c.queue
                    ? c.delay
                    ...
                    : u.queue(r, c.queue, function (e, i) {
                        return !0 === i
                          ? (I.promise && I.resolver(v), !0)
                          : ((g.velocityQueueEntryFlag = !0), void t());
                      }),
                  ("" !== c.queue && "fx" !== c.queue) ||
              ...
              if (
                ...
                switch (
                  ...
                  case "stop":
                    ...
                    var O = [];
                    return (
                      u.each(g.State.calls, function (t, e) {
                        e &&
                  ...
                  default:
                    if (!u.isPlainObject(b) || p.isEmptyObject(b)) {
                        ...
                        return (
                          ...
                          u.each(v, function (t, e) {
                            parseFloat(E.stagger)
                              ? (E.delay = A + parseFloat(E.stagger) * t)
                              : p.isFunction(E.stagger) &&
                                (E.delay = A + E.stagger.call(e, t, C)),
                              E.drag &&
                                ((E.duration =
                                  parseFloat(P) ||
                                  (/^(callout|transition)/.test(b) ? 1e3 : m)),
                                (E.duration = Math.max(
                                  E.duration *
                                    (E.backwards ? 1 - t / C : (t + 1) / C),
                                  0.75 * E.duration,
                                  200
                                ))),
                              g.Redirects[b].call(
                      ...
                      return (
                        I.promise ? I.rejecter(new Error(D)) : console.log(D),
                        t()
                      );
                    }
                    T = "start";
                ...
                if (
                  ...
                  ((E = u.extend({}, g.defaults, w)).loop = parseInt(E.loop)),
                  (_ = 2 * E.loop - 1),
                  E.loop)
                )
                  for (var F = 0; _ > F; F++) {
            ...
            return (
              ...
              (t.Velocity = g),
              t !== e &&
                ((t.fn.velocity = x), (t.fn.velocity.defaults = g.defaults)),
        ...
        4: [
          function (t, e, i) {
            ...
            function a(t) {
              ...
              return [
                n(t)[0],
                100 * ((1 / 255) * Math.min(e, Math.min(i, o))),
                100 * (o = 1 - (1 / 255) * Math.max(e, Math.max(i, o))),
              ];
            }
            function s(t) {
              var e,
            ...
            function m(t) {
              ...
              return (
                ...
                (e =
                  (e = 3.2406 * o + -1.5372 * a + -0.4986 * r) > 0.0031308
            ...
            function y(t) {
              ...
              return (
                a <= 8
                  ? (o = ((i = (100 * a) / 903.3) / 100) * 7.787 + 16 / 116)
                  : ((i = 100 * Math.pow((a + 16) / 116, 3)),
                    (o = Math.pow(i / 100, 1 / 3))),
                [
                  (e =
                    e / 95.047 <= 0.008856
                      ? (e = (95.047 * (r / 500 + o - 16 / 116)) / 7.787)
                      : 95.047 * Math.pow(r / 500 + o, 3)),
                  i,
                  (n =
                    n / 108.883 <= 0.008859
            ...
            function x(t) {
              var e,
                ...
                o = t[2];
              return (
                (e = (360 * Math.atan2(o, n)) / 2 / Math.PI) < 0 && (e += 360),
                              ...
                              return (
                                a.isNullOrUndef(r)
                                  ? ((n = e.min * i.categoryPercentage),
                                    (o = i.barPercentage))
                                  : ((n = r * s), (o = 1)),
                                { chunk: n / s, ratio: o, start: l - n / 2 }
                              );
                            })(e, i, n),
                      r = this.getStackIndex(t, this.getMeta().stack),
                      s = o.start + o.chunk * r + o.chunk / 2,
                      l = Math.min(
                        a.valueOrDefault(n.maxBarThickness, 1 / 0),
                        o.chunk * o.ratio
                      );
                    return {
                      base: s - l / 2,
                ...
                t.controllers.bubble = t.DatasetController.extend({
                  ...
                  setHoverStyle: function (t) {
                    ...
                    (t.$previousStyle = {
                      ...
                      (e.backgroundColor = a.valueOrDefault(
                        i.hoverBackgroundColor,
                        a.getHoverColor(i.backgroundColor)
                      )),
                      (e.borderColor = a.valueOrDefault(
                        i.hoverBorderColor,
                        a.getHoverColor(i.borderColor)
                      )),
                      (e.borderWidth = a.valueOrDefault(
                        i.hoverBorderWidth,
                        i.borderWidth
                      )),
                  ...
                  _resolveElementOptions: function (t, e) {
                    ...
                    return (
                      (h.radius = u(
                        [l.radius, d ? d.r : void 0, s.radius, c.radius],
                        p,
                        e
                      )),
                      h
              ...
              legend: {
                      ...
                      ? e.labels.map(function (i, n) {
                          ...
                          return {
                            ...
                            fillStyle: l.backgroundColor
                              ? l.backgroundColor
                              : c(r.backgroundColor, n, u.backgroundColor),
                            strokeStyle: l.borderColor
                              ? l.borderColor
                              : c(r.borderColor, n, u.borderColor),
                            lineWidth: l.borderWidth
                              ? l.borderWidth
                              : c(r.borderWidth, n, u.borderWidth),
                ...
                onClick: function (t, e) {
                  ...
                  for (i = 0, n = (r.data.datasets || []).length; i < n; ++i)
                    (o = r.getDatasetMeta(i)).data[a] &&
                      (o.data[a].hidden = !o.data[a].hidden);
                  r.update();
                },
              },
              cutoutPercentage: 50,
                  ...
                  t.DatasetController.extend({
                    ...
                    update: function (t) {
                      ...
                      if (p < 2 * Math.PI) {
                        var f = o.rotation % (2 * Math.PI),
                          m =
                            (f +=
                              2 *
                              Math.PI *
                              (f >= Math.PI ? -1 : f < -Math.PI ? 1 : 0)) + p,
                          v = { x: Math.cos(f), y: Math.sin(f) },
                          g = { x: Math.cos(m), y: Math.sin(m) },
                          b =
                            (f <= 0 && m >= 0) ||
                            (f <= 2 * Math.PI && 2 * Math.PI <= m),
                          y =
                            (f <= 0.5 * Math.PI && 0.5 * Math.PI <= m) ||
                            (f <= 2.5 * Math.PI && 2.5 * Math.PI <= m),
                          x =
                            (f <= -Math.PI && -Math.PI <= m) ||
                            (f <= Math.PI && Math.PI <= m),
                          w =
                            (f <= 0.5 * -Math.PI && 0.5 * -Math.PI <= m) ||
                            (f <= 1.5 * Math.PI && 1.5 * Math.PI <= m),
                          k = h / 100,
                          C = {
                            x: x
                              ? -1
                        ...
                        (c = Math.min(s / M.width, l / M.height)),
                          (u = {
                            x: -0.5 * (S.x + C.x),
                            y: -0.5 * (S.y + C.y),
                          });
                    ...
                    updateElement: function (t, e, i) {
                      var n = this,
                        ...
                        f =
                          i && l.animateRotate
                            ...
                            : t.hidden
                            ? 0
                            : n.calculateCircumference(p.data[e]) *
                      ...
                      (b.backgroundColor = y.backgroundColor
                        ? y.backgroundColor
                        : x(p.backgroundColor, e, w.backgroundColor)),
                        (b.borderColor = y.borderColor
                          ? y.borderColor
                          : x(p.borderColor, e, w.borderColor)),
                        (b.borderWidth = y.borderWidth
                          ? y.borderWidth
                          : x(p.borderWidth, e, w.borderWidth)),
                        (i && l.animateRotate) ||
                          ((b.startAngle =
                            0 === e
                              ? s.rotation
                    ...
                    getMaxBorderWidth: function (t) {
                      for (
                        var e, i, n = 0, o = this.index, a = t.length, r = 0;
                        r < a;
                        r++
                      )
                        (e = t[r]._model ? t[r]._model.borderWidth : 0),
                          (n =
                            (i = t[r]._chart
                              ? t[r]._chart.config.data.datasets[o]
                                  .hoverBorderWidth
                              : 0) > (n = e > n ? e : n)
                              ? i
                              : n);
                    ...
                    for (
                      f &&
                        ...
                        (l._model = {
                          ...
                          tension: o.tension
                            ? o.tension
                            : a.valueOrDefault(p.lineTension, d.tension),
                          backgroundColor: o.backgroundColor
                            ? o.backgroundColor
                            : p.backgroundColor || d.backgroundColor,
                          borderWidth: o.borderWidth
                            ? o.borderWidth
                            : p.borderWidth || d.borderWidth,
                          borderColor: o.borderColor
                            ? o.borderColor
                            : p.borderColor || d.borderColor,
                          borderCapStyle: o.borderCapStyle
                            ? o.borderCapStyle
                            : p.borderCapStyle || d.borderCapStyle,
                          borderDash: o.borderDash
                            ? o.borderDash
                            : p.borderDash || d.borderDash,
                          borderDashOffset: o.borderDashOffset
                            ? o.borderDashOffset
                            : p.borderDashOffset || d.borderDashOffset,
                          borderJoinStyle: o.borderJoinStyle
                            ? o.borderJoinStyle
                            : p.borderJoinStyle || d.borderJoinStyle,
                          fill: o.fill
                            ? o.fill
                            : void 0 !== p.fill
                            ? p.fill
                          ...
                          steppedLine: o.steppedLine
                            ? o.steppedLine
                            : a.valueOrDefault(p.steppedLine, d.stepped),
                    ...
                    return (
                      isNaN(o.rotation)
                        ? (isNaN(n.pointRotation) &&
                            !a.isArray(n.pointRotation)) ||
                          (i = a.valueAtIndexOrDefault(n.pointRotation, e, i))
                        : (i = o.rotation),
                      i
                    );
                  },
                  updateElement: function (t, e, i) {
                    ...
                    void 0 !== c.radius &&
                      ...
                      (t._model = {
                        ...
                        radius:
                          l.radius ||
                          a.valueAtIndexOrDefault(c.pointRadius, e, f.radius),
                        pointStyle:
                          l.pointStyle ||
                          a.valueAtIndexOrDefault(
                            c.pointStyle,
                  ...
                  calculatePointY: function (t, e, i) {
                    ...
                    if (l.options.stacked) {
                      for (n = 0; n < i; n++)
                        if (
                          ((o = r.data.datasets[n]),
                          "line" === (a = r.getDatasetMeta(n)).type &&
                            a.yAxisID === l.id &&
                  ...
                  updateBezierControlPoints: function () {
                    ...
                    if (
                      ...
                      for (t = 0, e = s.length; t < e; ++t)
                        (i = s[t]._model),
                          (n = a.splineCurve(
                            a.previousItem(s, t)._model,
                            i,
                            a.nextItem(s, t)._model,
              ...
              legend: {
                      ...
                      ? e.labels.map(function (i, n) {
                          ...
                          return {
                            ...
                            fillStyle: s.backgroundColor
                              ? s.backgroundColor
                              : l(r.backgroundColor, n, c.backgroundColor),
                            strokeStyle: s.borderColor
                              ? s.borderColor
                              : l(r.borderColor, n, c.borderColor),
                            lineWidth: s.borderWidth
                              ? s.borderWidth
                              : l(r.borderWidth, n, c.borderWidth),
                            hidden: isNaN(r.data[n]) || o.data[n].hidden,
                            index: n,
                          };
                        })
                ...
                onClick: function (t, e) {
                  var i,
                    ...
                    r = this.chart;
                  for (i = 0, n = (r.data.datasets || []).length; i < n; ++i)
                    (o = r.getDatasetMeta(i)).data[a].hidden =
                      !o.data[a].hidden;
                  r.update();
                },
              },
              ...
              (e.exports = function (t) {
                t.controllers.polarArea = t.DatasetController.extend({
                  ...
                  update: function (t) {
                    ...
                    for (
                      o._updateRadius(),
                        s.count = o.countVisibleElements(),
                        e = 0,
                        i = r.data.length;
                      e < i;
                      e++
                  ...
                  _updateRadius: function () {
                    ...
                    (e.outerRadius = Math.max((a - o.borderWidth / 2) / 2, 0)),
                      ...
                      (t.outerRadius =
                        e.outerRadius - e.radiusLength * t.index),
                  ...
                  updateElement: function (t, e, i) {
                    var n = this,
                      ...
                      f = t.hidden
                        ? 0
                        : c.getDistanceFromCenterForValue(r.data[e]),
                      m = n._starts[e],
                    ...
                    var b = this.chart.options.elements.arc,
                      ...
                      x = a.valueAtIndexOrDefault,
                      w = t._model;
                    (w.backgroundColor = y.backgroundColor
                      ? y.backgroundColor
                      : x(r.backgroundColor, e, b.backgroundColor)),
                      (w.borderColor = y.borderColor
                        ? y.borderColor
                        : x(r.borderColor, e, b.borderColor)),
                      (w.borderWidth = y.borderWidth
                        ? y.borderWidth
                        : x(r.borderWidth, e, b.borderWidth)),
                      t.pivot();
                  },
                ...
                t.controllers.radar = t.DatasetController.extend({
                  ...
                  updateBezierControlPoints: function () {
                    ...
                    a.each(e.data, function (i, n) {
                      var o = i._model,
                        r = a.splineCurve(
                          a.previousItem(e.data, n, !0)._model,
                          o,
                          a.nextItem(e.data, n, !0)._model,
                          o.tension
                        );
              ...
              (e.exports = {
                ...
                addAnimation: function (t, e, i, n) {
                  var o,
                    ...
                    r = this.animations;
                  for (
                    e.chart = t, n || (t.animating = !0), o = 0, a = r.length;
                    o < a;
                    ++o
                  )
                ...
                r.extend(t.prototype, {
                  ...
                  resize: function (t) {
                    var e = this,
                      ...
                      s = Math.max(
                        0,
                        Math.floor(o ? a / o : r.getMaximumHeight(n))
                      );
                    if (
                      ...
                      (n.style.width = a + "px"),
                      (n.style.height = s + "px"),
                      r.retinaScale(e, i.devicePixelRatio),
                      !t)
                    ) {
                  ...
                  buildOrUpdateScales: function () {
                    ...
                    i.scales &&
                      ...
                      r.each(o, function (i) {
                        ...
                        e(o.position) !== e(i.dposition) &&
                          (o.position = i.dposition),
                          (a[s] = !0);
                        var c = null;
                  ...
                  updateLayout: function () {
                    !1 !== u.notify(this, "beforeLayout") &&
                      (l.update(this, this.width, this.height),
                  ...
                  updateDataset: function (t) {
                    var e = this.getDatasetMeta(t),
                      i = { meta: e, index: t };
                    !1 !== u.notify(this, "beforeDatasetUpdate", [i]) &&
                      (e.controller.update(),
                      u.notify(this, "afterDatasetUpdate", [i]));
                  },
                  render: function (t) {
                    var e = this;
                    (t && "object" == typeof t) ||
                    ...
                    if (!1 !== u.notify(e, "beforeRender")) {
                      var s = e.options.animation,
                        l = function (t) {
                          u.notify(e, "afterRender"),
                            r.callback(s && s.onComplete, [t], e);
                        };
                      if (
                        s &&
                        ((void 0 !== i && 0 !== i) ||
                          (void 0 === i && 0 !== s.duration))
                      ) {
                        var c = new n({
                  ...
                  drawDataset: function (t, e) {
                    ...
                    !1 !== u.notify(this, "beforeDatasetDraw", [n]) &&
                      (i.controller.draw(e),
                      u.notify(this, "afterDatasetDraw", [n]));
                  },
                  _drawTooltip: function (t) {
                    var e = this.tooltip,
                      i = { tooltip: e, easingValue: t };
                    !1 !== u.notify(this, "beforeTooltipDraw", [i]) &&
                      (e.draw(), u.notify(this, "afterTooltipDraw", [i]));
                  },
              ...
              (t.DatasetController = function (t, e) {
                ...
                n.extend(t.DatasetController.prototype, {
                  ...
                  removeHoverStyle: function (t) {
                    n.merge(t._model, t.$previousStyle || {}),
                  ...
                  setHoverStyle: function (t) {
                    ...
                    (t.$previousStyle = {
                      ...
                      (s.backgroundColor = o.hoverBackgroundColor
                        ...
                        : a(e.hoverBackgroundColor, i, r(s.backgroundColor))),
                      (s.borderColor = o.hoverBorderColor
                        ? o.hoverBorderColor
                        : a(e.hoverBorderColor, i, r(s.borderColor))),
                      (s.borderWidth = o.hoverBorderWidth
                        ? o.hoverBorderWidth
                        : a(e.hoverBorderWidth, i, s.borderWidth));
                  },
          ...
          function (t, e, i) {
            ...
            o.extend(a.prototype, {
              ...
              pivot: function () {
                var t = this;
                return (
                  t._view || (t._view = o.clone(t._model)), (t._start = {}), t
                );
              },
              transition: function (t) {
                var e = this,
          ...
          function (t, e, i) {
            ...
            e.exports = function () {
              ...
              function i(i, n, o) {
                ...
                return u || d
                  ? Math.min(u ? t(l, i, o) : h, d ? t(c, s, o) : h)
                  : "none";
              }
              (a.configMerge = function () {
                  ...
                  [].slice.call(arguments, 1),
                  {
                    merger: function (t, e, i, n) {
                      var o = e[t] || {},
                        s = i[t];
                      "scales" === t
                        ? (e[t] = a.scaleMerge(o, s))
                        : "scale" === t
                        ? (e[t] = a.merge(o, [r.getScaleDefaults(s.type), s]))
                        : a._merger(t, e, i, n);
                    },
                  }
                );
                        ...
                        if ("xAxes" === t || "yAxes" === t) {
                          ...
                          for (e[t] || (e[t] = []), o = 0; o < c; ++o)
                            (l = i[t][o]),
                              ...
                              !e[t][o].type ||
                              (l.type && l.type !== e[t][o].type)
                                ? a.merge(e[t][o], [r.getScaleDefaults(s), l])
                                : a.merge(e[t][o], l);
                ...
                (a.getRelativePosition = function (t, e) {
                  ...
                  return {
                    x: (i = Math.round(
                      (((i - s.left - c) / p) * r.width) /
                        e.currentDevicePixelRatio
                    )),
                    y: (n = Math.round(
                      (((n - s.top - u) / f) * r.height) /
                        e.currentDevicePixelRatio
                    )),
                  };
                }),
                ...
                (a._calculatePadding = function (t, e, i) {
                  return (e = a.getStyle(t, e)).indexOf("%") > -1
                    ? i / parseInt(e, 10)
                    : parseInt(e, 10);
                }),
                ...
                (a.getMaximumWidth = function (t) {
                  ...
                  var i = e.clientWidth,
                    n =
                      i -
                      a._calculatePadding(e, "padding-left", i) -
                      a._calculatePadding(e, "padding-right", i),
                ...
                (a.getMaximumHeight = function (t) {
                  ...
                  var i = e.clientHeight,
                    n =
                      i -
                      a._calculatePadding(e, "padding-top", i) -
                      a._calculatePadding(e, "padding-bottom", i),
                ...
                (a.measureText = function (t, e, i, n, o) {
                  var a = e[o];
                  return (
                    a || ((a = e[o] = t.measureText(o).width), i.push(o)),
                    a > n && (n = a),
                    n
                  );
                }),
                ...
                (a.getHoverColor = function (t) {
                  return t instanceof CanvasPattern
                    ? t
                    : a.color(t).saturate(0.5).darken(0.1).rgbString();
                });
            };
          },
            ...
            function a(t, e) {
              ...
              for (n = 0, a = t.data.datasets.length; n < a; ++n)
                if (t.isDatasetVisible(n))
                  for (
                    o = 0, r = (i = t.getDatasetMeta(n)).data.length;
                    o < r;
                    ++o
                  ) {
                    var s = i.data[o];
            ...
            e.exports = {
              modes: {
                ...
                dataset: function (t, e, i) {
                  ...
                  return (
                    c.length > 0 &&
                      (c = t.getDatasetMeta(c[0]._datasetIndex).data),
                    c
                  );
                },
                "x-axis": function (t, e) {
          ...
          function (t, e, i) {
            ...
            e.exports = {
              ...
              configure: function (t, e, i) {
                for (
                  var n,
                    o = ["fullWidth", "position", "weight"],
                    a = o.length,
                    r = 0;
                  r < a;
                  ++r
                )
                  (n = o[r]), i.hasOwnProperty(n) && (e[n] = i[n]);
              },
                ...
                if (t) {
                  ...
                  n.each(h.concat(p, f, m), function (t) {
                    var e,
                      i = t.isHorizontal();
                    i
                      ? ((e = t.update(t.fullWidth ? g : k, w)),
                        (C -= e.height))
                      : ((e = t.update(x, C)), (k -= e.width)),
                  ...
                  n.each(h.concat(p), V),
                    ...
                    n.each(h.concat(p), function (t) {
                      var e = n.findNextWhere(S, function (e) {
                        ...
                        i = { left: 0, right: 0, top: D, bottom: _ };
                  ...
                  var L = Math.max(I - D, 0);
                  (D += L), (_ += Math.max(O - _, 0));
                  var $ = i - D - _,
                    F = e - P - A;
                  (F === k && $ === C) ||
                    (n.each(h, function (t) {
            ...
            n._set("global", { plugins: {} }),
              (e.exports = {
                ...
                notify: function (t, e, i) {
                  ...
                  for (n = 0; n < c; ++n)
                    if (
                      "function" == typeof (s = (a = (o = l[n]).plugin)[e]) &&
                      ((r = [t].concat(i || [])).push(o.options),
                      !1 === s.apply(a, r))
                    )
                      return !1;
                  return !0;
                    ...
                    this._plugins.concat(r.plugins || []).forEach(function (t) {
                      if (-1 === i.indexOf(t)) {
                        var e = t.id,
                          r = s[e];
                        !1 !== r &&
                          (!0 === r && (r = o.clone(n.global.plugins[e])),
                          i.push(t),
                          a.push({ plugin: t, options: r || {} }));
                      }
                    }),
                    (e.descriptors = a),
                    (e.id = this._cacheId),
          ...
          function (t, e, i) {
            ...
            function d(t) {
              return a.options.toLineHeight(
                a.valueOrDefault(t.lineHeight, 1.2),
                a.valueOrDefault(t.fontSize, n.global.defaultFontSize)
              );
            }
            n._set("scale", {
              display: !0,
              ...
              (e.exports = o.extend({
                ...
                calculateTickRotation: function () {
                  ...
                  if (n.length && t.options.display && t.isHorizontal())
                    for (
                      var l,
                        c = a.longestText(e, o.font, n, t.longestTextCache),
                        d = c,
                ...
                fit: function () {
                  ...
                  if (
                    ((e.width = p
                      ...
                      ? m
                      : 0),
                    (e.height = p ? (h && l.drawTicks ? m : 0) : t.maxHeight),
                    r.display && h)
                  ) {
                  ...
                  if (o.display && h) {
                    ...
                    if (p) {
                      ...
                      (e.height = Math.min(t.maxHeight, e.height + C + x)),
                        (t.ctx.font = f.font);
                      var S = c(t.ctx, i[0], f.font),
                        M = c(t.ctx, i[i.length - 1], f.font);
                      0 !== t.labelRotation
                        ? ((t.paddingLeft =
                            "bottom" === n.position ? k * S + 3 : k * y + 3),
                          (t.paddingRight =
                            "bottom" === n.position ? k * y + 3 : k * M + 3))
                        : ((t.paddingLeft = S / 2 + 3),
                          (t.paddingRight = M / 2 + 3));
                    } else
                      o.mirror ? (g = 0) : (g += x + y),
                        (e.width = Math.min(t.maxWidth, e.width + g)),
                ...
                draw: function (t) {
                  ...
                  if (i.display) {
                    var o = e.ctx,
                      ...
                      A =
                        "bottom" === i.position ? e.top + I : e.bottom - w - I,
                      D =
                        "bottom" === i.position ? e.top + I + w : e.bottom + I;
                    if (
                      (a.each(v, function (n, o) {
                        if (!a.isNullOrUndef(n.label)) {
                          ...
                          if (m) {
                            ...
                            N < e.left && (u = "rgba(0,0,0,0)"),
                              (N += a.aliasPixel(c)),
                              (E = e.getPixelForTick(o) + s.labelOffset),
                              (g = y = k = S = N),
                              (b = A),
                              (x = D),
                              (C = t.top),
                            ...
                            s.mirror
                              ? ((F = H ? "left" : "right"), (z = W))
                              : ((F = H ? "right" : "left"), (z = w + W)),
                              (E = H ? e.right - z : e.left + z);
                            var B = l(e, o, h.offsetGridLines && v.length > 1);
                            B < e.top && (u = "rgba(0,0,0,0)"),
                              (B += a.aliasPixel(c)),
                              (L = e.getPixelForTick(o) + s.labelOffset),
                              (g = O),
                              (y = P),
                              (k = t.left),
                              (S = t.right + I),
                      ...
                      a.each(T, function (t) {
                        if (
                          ...
                          o.save(),
                            ...
                            o.rotate(t.rotation),
                            (o.font = t.major ? x.font : b.font),
                            (o.fillStyle = t.major ? y : g),
                          ...
                          if (a.isArray(i))
                            for (
                              var n = i.length,
                                r = 1.5 * b.size,
                                l = e.isHorizontal() ? 0 : (-r * (n - 1)) / 2,
                                c = 0;
                              c < n;
                              ++c
                            )
                              o.fillText("" + i[c], 0, l), (l += r);
                      ...
                      if (m)
                        ...
                        (_ = F ? e.left + $ + S.top : e.right - $ - S.top),
                          (E = e.top + (e.bottom - e.top) / 2),
                          (L = F ? -0.5 * Math.PI : 0.5 * Math.PI);
                      }
                      o.save(),
                        o.translate(_, E),
                        o.rotate(L),
                        ...
                        (o.fillStyle = k),
                        (o.font = C.font),
                        o.fillText(p.labelString, 0, 0),
                        o.restore();
                    }
                    if (h.drawBorder) {
                      (o.lineWidth = a.valueAtIndexOrDefault(h.lineWidth, 0)),
                        (o.strokeStyle = a.valueAtIndexOrDefault(h.color, 0));
                      var R = e.left,
                        W = e.right + I,
                        V = e.top,
                        N = e.bottom + I,
                      ...
                      m
                        ? ((V = N = "top" === i.position ? e.bottom : e.top),
                          (V += z),
                          (N += z))
                        : ((R = W = "left" === i.position ? e.right : e.left),
                          (R += z),
                          (W += z)),
                        o.beginPath(),
                        o.moveTo(R, V),
            ...
            e.exports = {
              ...
              getScaleDefaults: function (t) {
                return this.defaults.hasOwnProperty(t)
                  ? o.merge({}, [n.scale, this.defaults[t]])
                  : {};
              },
              updateScaleDefaults: function (t, e) {
                this.defaults.hasOwnProperty(t) &&
                  (this.defaults[t] = o.extend(this.defaults[t], e));
              },
        ...
        36: [
          function (t, e, i) {
            ...
            function l(t, e) {
              return (
                e &&
                  (a.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
                t
              );
            }
            function c(t) {
            ...
            (e.exports = o.extend({
              ...
              getBody: function (t, e) {
                ...
                return (
                  a.each(t, function (t) {
                    ...
                    l(a.before, c(n.beforeLabel.call(i, t, e))),
                      l(a.lines, n.label.call(i, t, e)),
                      l(a.after, c(n.afterLabel.call(i, t, e))),
                      o.push(a);
                  }),
                  o
                );
              ...
              update: function (t) {
                var e,
                  ...
                  m = d._active,
                  v = d._data,
                  g = { xAlign: p.xAlign, yAlign: p.yAlign },
                  b = { x: p.x, y: p.y },
                ...
                if (m.length) {
                  ...
                  h.filter &&
                    ...
                    (f.title = d.getTitle(C, v)),
                    (f.beforeBody = d.getBeforeBody(C, v)),
                    (f.body = d.getBody(C, v)),
                    (f.afterBody = d.getAfterBody(C, v)),
                    (f.footer = d.getFooter(C, v)),
                    (f.x = Math.round(x.x)),
                    (f.y = Math.round(x.y)),
                    ...
                    (b = (function (t, e, i, n) {
                      ...
                      (g = (function (t, e) {
                        ...
                        "center" === d
                          ...
                          i(s.x)
                            ? ((u = "left"),
                              o(s.x) && ((u = "center"), (d = r(s.y))))
                            : n(s.x) &&
                              ((u = "right"),
                              a(s.x) && ((u = "center"), (d = r(s.y))));
                        var f = t._options;
                        return {
              ...
              drawTitle: function (t, e, i, n) {
                ...
                if (o.length) {
                  ...
                  var r,
                    ...
                    u = e.titleSpacing;
                  for (
                    i.fillStyle = s(e.titleFontColor, n),
                      i.font = a.fontString(
                        c,
                        e._titleFontStyle,
                        e._titleFontFamily
                    ...
                    i.fillText(o[r], t.x, t.y),
                      (t.y += c + u),
                      r + 1 === o.length && (t.y += e.titleMarginBottom - u);
                }
              },
                    ...
                    (i.fillStyle = c),
                      ...
                      a.each(r.lines, function (a) {
                        d &&
                          ...
                          (i.fillStyle = s(
                            e.labelColors[l].backgroundColor,
                            n
                          )),
              ...
              drawBackground: function (t, e, i, n, o) {
                (i.fillStyle = s(e.backgroundColor, o)),
                  (i.strokeStyle = s(e.borderColor, o)),
              ...
              handleEvent: function (t) {
                ...
                return (
                  ...
                  (e = !a.arrayEquals(i._active, i._lastActive)) &&
            ...
            n._set("global", {
              ...
              (e.exports = o.extend({
                ...
                inRange: function (t, e) {
                  ...
                  if (i) {
                    for (
                      var n = a.getAngleFromPoint(i, { x: t, y: e }),
                        o = n.angle,
                        r = n.distance,
                        s = i.startAngle,
                        l = i.endAngle;
                ...
                draw: function () {
                  ...
                  for (
                    this._loop && c.length && c.push(c[0]),
                      ...
                      s.setLineDash &&
                        s.setLineDash(o.borderDash || u.borderDash),
                      s.lineDashOffset =
                        o.borderDashOffset || u.borderDashOffset,
                    ...
                    (e = c[t]),
                      ...
                      (n = e._view),
                      0 === t
                        ? n.skip || (s.moveTo(n.x, n.y), (d = t))
                        : ((i = -1 === d ? i : c[d]),
                          n.skip ||
                            ((d !== t - 1 && !l) || -1 === d
                              ? s.moveTo(n.x, n.y)
                              : a.canvas.lineTo(s, i._view, e._view),
                            (d = t)));
                  s.stroke(), s.restore();
                },
              }));
              ...
              o = {
                ...
                each: function (t, e, i, n) {
                  ...
                  if (o.isArray(t))
                    ...
                    for (r = (s = Object.keys(t)).length, a = 0; a < r; a++)
                      e.call(i, t[s[a]], s[a]);
                },
                ...
                _mergerIf: function (t, e, i) {
                  var n = e[t],
                    a = i[t];
                  o.isObject(n) && o.isObject(a)
                    ? o.mergeIf(n, a)
                    : e.hasOwnProperty(t) || (e[t] = o.clone(a));
                },
          ...
          function (t, e, i) {
            ...
            function h(t, e, i, n, o) {
              ...
              if (n && o) {
                ...
                for (t.lineTo(i[o - 1].x, i[o - 1].y), r = o - 1; r > 0; --r)
                    ...
                    (function (t, e, i, n, o, a) {
                      ...
                      for (t.beginPath(), r = 0, s = m + !!a; r < s; ++r)
                        (u = i((c = e[(l = r % m)]._view), l, n)),
                          ...
                          (f = d(u)),
                          p && f
                            ? ((y = g.push(c)), (x = b.push(u)))
                            : y &&
                              x &&
                              (v
                                ? (p && g.push(c), f && b.push(u))
                                : (h(t, g, b, y, x),
                                  (y = x = 0),
                                  (g = []),
                                  (b = [])));
                  ...
                  if (((r.font = p), v)) {
                    ...
                    (r.textAlign = "left"),
                      ...
                      a.each(t.legendItems, function (e, n) {
                        ...
                        g[g.length - 1] + o + i.padding >= t.width &&
                          ((b += u + i.padding), (g[g.length] = t.left)),
                          (f[n] = { left: 0, top: 0, width: o, height: u }),
                    ...
                    a.each(t.legendItems, function (t, e) {
                      ...
                      C + S > m.height &&
                        ((w += k + i.padding), x.push(k), (k = 0), (C = 0)),
                        (k = Math.max(k, n)),
                        (C += S),
                        (f[e] = { left: 0, top: 0, width: n, height: u });
                    }),
                      (w += k),
                      x.push(k),
                      (m.width += w);
                  ...
                  a.each(t.legendItems, function (n, l) {
                    ...
                    x
                      ? v + m >= s &&
                        ((g = u.y += w),
                        u.line++,
                        (v = u.x = t.left + (s - c[u.line]) / 2))
                      : g + w > t.bottom &&
                        ((v = u.x = v + t.columnWidths[u.line] + i.padding),
                        (g = u.y = t.top + i.padding),
                        u.line++),
                      (function (t, i, n) {
                        if (!(isNaN(b) || b <= 0)) {
                          d.save(),
                          ...
                          if (
                            (d.setLineDash &&
                              d.setLineDash(h(n.lineDash, r.borderDash)),
          ...
          function (t, e, i) {
            ...
            var l = o.extend({
              ...
              fit: function () {
                ...
                t.isHorizontal()
                  ? ((s.width = t.maxWidth), (s.height = u))
                  : ((s.width = u), (s.height = t.maxHeight)),
                  (t.width = s.width),
                  (t.height = s.height);
              },
              afterFit: s,
              ...
              draw: function () {
                ...
                if (o.display) {
                  ...
                  (e.fillStyle = i(o.fontColor, r.defaultFontColor)),
                    (e.font = p),
                    t.isHorizontal()
                      ? ((l = b + (x - b) / 2), (c = g + m), (s = x - b))
                      : ((l = "left" === o.position ? b + m : x - m),
                        (c = g + (y - g) / 2),
                        (s = y - g),
                        (v = Math.PI * ("left" === o.position ? -0.5 : 0.5))),
                    e.save(),
                    e.translate(l, c),
                    e.rotate(v),
                    (e.textAlign = "center"),
            ...
            e.exports = {
              ...
              beforeUpdate: function (t) {
                var e = t.options.title,
                  i = t.titleBlock;
                e
                  ? (a.mergeIf(e, n.global.title),
                    i ? (r.configure(t, i, e), (i.options = e)) : c(t, e))
                ...
                i = t.LinearScaleBase.extend({
                    ...
                    if (
                      ...
                      o.each(n, function (n, a) {
                        var s = i.getDatasetMeta(a),
                          c = [
                            s.type,
                            void 0 === e.stacked && void 0 === s.stack ? a : "",
                            s.stack,
                          ].join(".");
                        void 0 === l[c] &&
                          (l[c] = { positiveValues: [], negativeValues: [] });
                  ...
                  getPixelForValue: function (t) {
                    ...
                    return e.isHorizontal()
                      ? e.left + (e.width / o) * (n - i)
                      : e.bottom - (e.height / o) * (n - i);
                  },
                  getValueForPixel: function (t) {
                    var e = this,
                      i = e.isHorizontal(),
            ...
            e.exports = function (t) {
              ...
              t.LinearScaleBase = o.extend({
                getRightValue: function (t) {
                  return "string" == typeof t
                    ? +t
                    : o.prototype.getRightValue.call(this, t);
                },
                  ...
                  var t = this,
                    ...
                    a = (t.ticks = (function (t, e) {
                      ...
                      if (t.stepSize && t.stepSize > 0) a = t.stepSize;
                        ...
                        (a = n.niceNum(s / (t.maxTicks - 1), !0)),
                          void 0 !== (o = t.precision) &&
                            ((i = Math.pow(10, o)), (a = Math.ceil(a * i) / i));
                      }
                      var l = Math.floor(e.min / a) * a,
                        c = Math.ceil(e.max / a) * a;
                      n.isNullOrUndef(t.min) ||
                        n.isNullOrUndef(t.max) ||
                        !t.stepSize ||
                        (n.almostWhole((t.max - t.min) / t.stepSize, a / 1e3) &&
                          ((l = t.min), (c = t.max)));
                      var u = (c - l) / a;
                      (u = n.almostEquals(u, Math.round(u), a / 1e3)
                        ? Math.round(u)
                        : Math.ceil(u)),
                        (o = 1),
                        a < 1 &&
                          ((o = Math.pow(10, 1 - Math.floor(n.log10(a)))),
                          (l = Math.round(l * o) / o),
                          (c = Math.round(c * o) / o)),
                        r.push(void 0 !== t.min ? t.min : l);
                      for (var d = 1; d < u; ++d)
                        r.push(Math.round((l + d * a) * o) / o);
                ...
                convertTicksToLabels: function () {
                  ...
                  (t.ticksAsNumbers = t.ticks.slice()),
                    ...
                    o.prototype.convertTicksToLabels.call(t);
                },
              });
            };
          },
                ...
                i = o.extend({
                  ...
                  convertTicksToLabels: function () {
                    (this.tickValues = this.ticks.slice()),
                      o.prototype.convertTicksToLabels.call(this);
                  },
                  getLabelForIndex: function (t, e) {
                    return +this.getRightValue(
                      this.chart.data.datasets[e].data[t]
                  ...
                  getPixelForValue: function (e) {
                    ...
                    return (
                      (e = +l.getRightValue(e)),
                      c
                        ? ((a = l.end), (r = l.start), (s = -1))
                        : ((a = l.start), (r = l.end), (s = 1)),
                      l.isHorizontal()
                        ? ((i = l.width), (o = c ? l.right : l.left))
                        : ((i = l.height),
                          (s *= -1),
                          (o = c ? l.top : l.bottom)),
                      e !== a &&
                        ...
                        for (e = 0; e < m; e++) {
                          (n = t.getPointPosition(e, r)),
                            ...
                            (i = o.isArray(f)
                              ...
                              : { w: h.measureText(f).width, h: p }),
                            (t._pointLabelSizes[e] = i);
                          var v = t.getIndexAngle(e),
                            g = o.toDegrees(v) % 360,
                            b = c(g, n.x, i.w, 0, 180),
                            y = c(g, n.y, i.h, 90, 270);
                          b.start < u.l && ((u.l = b.start), (d.l = v)),
                            b.end > u.r && ((u.r = b.end), (d.r = v)),
                            y.start < u.t && ((u.t = y.start), (d.t = v)),
                            y.end > u.b && ((u.b = y.end), (d.b = v));
                        }
                        ...
                        if (
                          (n.display &&
                            ...
                            (function (t, e, i, n) {
                              var a = t.ctx;
                              if (
                                ((a.strokeStyle = o.valueAtIndexOrDefault(
                                  e.color,
                                  n - 1
                                )),
                                (a.lineWidth = o.valueAtIndexOrDefault(
                                  e.lineWidth,
                                  n - 1
                                )),
                          ...
                          for (var f = s(t) - 1; f >= 0; f--) {
                            ...
                            if (r.display) {
                              ...
                              var b = t.getIndexAngle(f),
                                y = o.toDegrees(b);
                              (i.textAlign = u(y)),
                                h(y, t._pointLabelSizes[f], v),
                                d(i, t.pointLabels[f] || "", v, p.size);
                            }
                          }
                        })(t);
                  }
          ...
          function (t, e, i) {
            ...
            function p(t) {
              var e,
                ...
                a = [];
              for (e = 0, i = t.length; e < i; ++e)
                o[(n = t[e])] || ((o[n] = !0), a.push(n));
              return a;
            }
            function f(t, e, i, n) {
              var o = (function (t, e, i) {
                  for (
                    var n, o, a, r = 0, s = t.length - 1;
                    r >= 0 && r <= s;

                  ) {
                    if (
                      ((o = t[(n = (r + s) >> 1) - 1] || null), (a = t[n]), !o)
                    )
                      return { lo: null, hi: a };
                    if (a[e] < i) r = n + 1;
                    else {
            ...
            function m(t, e) {
              ...
              return "function" == typeof i
                ? i(t)
                : "string" == typeof t && "string" == typeof o
                ? n(t, o)
              ...
              for (
                p ||
                  (p = (function (t, e, i, n) {
                    ...
                    for (
                      o = 0, a = d.length;
                      o < a && ((r = d[o]), !(Math.ceil(s / (c * r)) <= n));
                      ++o
                    );
                    return r;
                  })(t, e, l, i)),
                  f && ((b = b.isoWeekday(f)), (y = y.isoWeekday(f))),
                  b = b.startOf(f ? "day" : l),
                  (y = y.startOf(f ? "day" : l)) < e && y.add(1, l),
                  r = n(b),
                  m &&
                    h &&
                    !f &&
                    !s.round &&
                    (r.startOf(h), r.add(~~((b - r) / (v.size * p)) * p, l));
                r < y;
                r.add(p, l)
              )
                x.push(+r);
            ...
            e.exports = function () {
              var t = r.extend({
                ...
                getRightValue: function (t) {
                  return (
                    t && void 0 !== t.t && (t = t.t),
                    r.prototype.getRightValue.call(this, t)
                  );
                },
                determineDataLimits: function () {
                  var t,
                    ...
                    x = [],
                    w = [];
                  for (t = 0, i = d.data.labels.length; t < i; ++t)
                    w.push(v(d.data.labels[t], u));
                  for (t = 0, i = (d.data.datasets || []).length; t < i; ++t)
                    if (d.isDatasetVisible(t))
                      if (((r = d.data.datasets[t].data), a.isObject(r[0])))
                        for (x[t] = [], e = 0, o = r.length; e < o; ++e)
                          (s = v(r[e], u)), y.push(s), (x[t][e] = s);
                  ...
                  w.length &&
                    ...
                    (b = b === l ? +n().endOf(m) + 1 : b),
                    (u.min = Math.min(g, b)),
                    (u.max = Math.max(g + 1, b)),
                    (u._horizontal = u.isHorizontal()),
                    (u._table = []),
                    (u._timestamps = { data: y, datasets: x, labels: w });
                },
                buildTicks: function () {
                  var t,
                    e,
                    ...
                    (o._unit =
                      ...
                      (function (t, e, i, o) {
                        ...
                        for (a = d.length - 1; a >= d.indexOf(e); a--)
                          if (((r = d[a]), u[r].common && s.as(r) >= t.length))
                            return r;
                        return d[e ? d.indexOf(e) : 0];
                      })(h, l.minUnit, o.min, o.max)),
                    (o._majorUnit = g(o._unit)),
                ...
                getLabelForIndex: function (t, e) {
                  ...
                  return (
                    a.isObject(r) && (o = this.getRightValue(r)),
                    n.tooltipFormat
                      ? m(o, n).format(n.tooltipFormat)
                      : "string" == typeof o
                      ? o
                      : m(o, n).format(this._labelFormat)
                  );
                },
                ...
                getLabelWidth: function (t) {
                  ...
                  return (
                    i * r +
                    a.valueOrDefault(e.fontSize, o.global.defaultFontSize) * s
                  );
                },
            ...
            t(".wow").each(function () {
              if (
                ...
                ((i + n - 100 > o(this) && n < o(this)) ||
                  (i + n - 100 > o(this) + t(this).height() &&
                    n < o(this) + t(this).height()) ||
                  (i + n == t(document).height() &&
                    o(this) + 100 > t(document).height()))
              ) {
                ...
                if (r) {
                  ...
                  t(s).addClass("animated"),
                    ...
                    t(s).css({ "animation-delay": r }),
                    t(s).css({ "animation-name": e[a] });
              ...
              i
                ? ((e = window.innerHeight),
                  ...
                  t(".wow.animated").each(function () {
                    if (
                      (e + a - 100 > o(this) && a > o(this) + 100) ||
                      (e + a - 100 < o(this) && a < o(this) + 100) ||
                      o(this) + t(this).height > t(document).height() - 100
                    )
  ...
  (function (t, e) {
    ...
    var l = {
        ...
        show: function (t, e, i) {
          ...
          "touches" in t && t.touches.length
            ...
            : ((a = t.pageY - o.top), (c = t.pageX - o.left)),
            (c = c >= 0 ? c : 0),
            (a = a >= 0 ? a : 0);
    ...
    var d = {
      ...
      allowEvent: function (t) {
        var e = !0;
        return (
          /^(mousedown|mousemove)$/.test(t.type) && d.touches && (e = !1), e
        );
      },
    ...
    return (
      ...
      (t.calm = function (t) {
        for (
          var e = { type: "mouseup", button: 1 }, i = 0, n = (t = a(t)).length;
          i < n;
          i++
        )
          l.hide(e, t[i]);
  ...
  (function (t) {
    t(document).on("click.card", ".card", function (e) {
      ...
      t(window).on("load", function () {
        ...
        e > i
          ? t(".card-wrapper, .back").height(e)
          : e > i
          ? t(".card-wrapper, .front").height(i)
          : t(".card-wrapper").height(i);
      }),
                  ...
                  (e = (function (i) {
                    return (
                      (e = t("<div/>")
                        ...
                        .attr("role", "alert")).appendTo(t(i.target)),
                      e
                    );
                  })(i)),
                e)
        ...
        function u(i) {
          ...
          if (
            (void 0 !== i.optionsOverride &&
              ((a = t.extend(a, i.optionsOverride)),
            ...
            return (
              ...
              i.title &&
                (p.append(i.title).addClass(a.titleClass), u.append(p)),
              i.message &&
                (f.append(i.message).addClass(a.messageClass), u.append(f)),
              a.closeButton &&
              ...
              a.timeOut > 0 &&
                ((l = setTimeout(y, a.timeOut)),
                (g.maxHideTime = parseFloat(a.timeOut)),
                (g.hideEta = new Date().getTime() + g.maxHideTime),
                a.progressBar && (g.intervalId = setInterval(k, 10))),
              (function () {
          ...
          function y(e) {
            if (!t(":focus", u).length || e)
              return (
                clearTimeout(g.intervalId),
                u[a.hideMethod]({
                  duration: a.hideDuration,
                  easing: a.hideEasing,
                  complete: function () {
                    h(u),
                      a.onHidden && "hidden" !== b.state && a.onHidden(),
                      (b.state = "hidden"),
                      (b.endTime = new Date()),
                      c(b);
                  },
          ...
          function x() {
            (a.timeOut > 0 || a.extendedTimeOut > 0) &&
              ((l = setTimeout(y, a.extendedTimeOut)),
              (g.maxHideTime = parseFloat(a.extendedTimeOut)),
              (g.hideEta = new Date().getTime() + g.maxHideTime));
          }
          function w() {
            clearTimeout(l),
        ...
        function h(t) {
          e || (e = s()),
            t.is(":visible") ||
              (t.remove(),
              (t = null),
              0 === e.children().length && (e.remove(), (n = void 0)));
        }
      })();
    });
  })(
      ...
      (t.fn.dropdown = function (e) {
        ...
        function n(e, n) {
          var o = window.innerHeight,
            a = e.innerHeight(),
            r = e.offset().left,
            s = e.offset().top - t(window).scrollTop(),
            l = i.alignment,
            c = 0,
            u = 0,
            d = 0;
          ...
          if (
            (!p.is("body") &&
              ...
              (h = p[0].scrollTop),
            r + n.innerWidth() > t(window).width()
              ? (l = "right")
              : r - n.innerWidth() + e.innerWidth() < 0 && (l = "left"),
            s + n.innerHeight() > o)
          )
          ...
          if ("left" === l) (c = i.gutter), (u = e.position().left + c);
          else if ("right" === l) {
            u =
              e.position().left +
              e.outerWidth() -
        ...
        return (
          this.each(function () {
            ...
            function r() {
              void 0 !== e.data("induration") &&
                (i.inDuration = e.data("inDuration")),
                void 0 !== e.data("outduration") &&
                  (i.outDuration = e.data("outDuration")),
                void 0 !== e.data("constrainwidth") &&
                  (i.constrain_width = e.data("constrainwidth")),
                void 0 !== e.data("hover") && (i.hover = e.data("hover")),
                void 0 !== e.data("gutter") && (i.gutter = e.data("gutter")),
                void 0 !== e.data("beloworigin") &&
                  (i.belowOrigin = e.data("beloworigin")),
                void 0 !== e.data("alignment") &&
                  (i.alignment = e.data("alignment")),
                void 0 !== e.data("maxheight") &&
                  (i.maxHeight = e.data("maxheight")),
                void 0 !== e.data("resetscroll") &&
                  (i.resetScroll = "true" === e.data("resetscroll"));
            }
            function s(s) {
              "focus" === s && (o = !0),
                r(),
                ...
                a
                  ...
                  .animate(
                    ...
                    { queue: !1, duration: i.inDuration, easing: "easeOutSine" }
                  );
            }
            function l() {
              (o = !1),
            ...
            if ((r(), e.after(a), i.hover)) {
              var c = !1;
              e.unbind("click.".concat(e.attr("id"))),
                e.on("mouseenter", function () {
                  !1 === c && (s(), (c = !0));
                }),
                e.on("mouseleave", function (e) {
                  var i = e.toElement || e.relatedTarget;
                  t(i).closest(".dropdown-content").is(a) ||
                    (a.stop(!0, !0), l(), (c = !1));
                }),
                a.on("mouseleave", function (i) {
                  var n = i.toElement || i.relatedTarget;
                  t(n).closest(".dropdown-button").is(e) ||
                    (a.stop(!0, !0), l(), (c = !1));
                });
            } else
              e.unbind("click.".concat(e.attr("id"))),
                e.bind("click.".concat(e.attr("id")), function (i) {
                  o ||
                    (e[0] !== i.currentTarget ||
                    e.hasClass("active") ||
                    0 !== t(i.target).closest(".dropdown-content").length
                      ? e.hasClass("active") &&
                        (l(),
                        t(document).unbind(
                          "click."
      ...
      (t.fn.mdbDropSearch = function (e) {
        ...
        this.filter(function (e, n) {
          t(n).on("keyup", function () {
            for (
              var t = i.closest("div[id]").find("a, li"), e = 0;
              e < t.length;
              e++
            )
              t.eq(e).html().toUpperCase().indexOf(i.val().toUpperCase()) > -1
                ? t.eq(e).css({ display: "" })
                : t.eq(e).css({ display: "none" });
          });
        });
        var n = t.extend(
          {
...
function dropdownEffectStart(t, e) {
  e &&
    (t.dropdown.addClass("dropdown-animating"),
...
dropdownSelectors.on({
  ...
  $(".multi-level-dropdown .dropdown-submenu > a").on(
    ...
    function (t) {
      var e = $(this);
      $(".multi-level-dropdown .dropdown-submenu .dropdown-menu").removeClass(
        "show"
      ),
        e.next(".dropdown-menu").addClass("show"),
        t.stopPropagation();
    }
  ),
  ...
  (function (t) {
    ...
    t(".fixed-action-btn:not(.smooth-scroll) > .btn-floating").on(
      "click",
      function (o) {
        if (!t(e).hasClass("smooth-scroll"))
          return (
            o.preventDefault(),
            (a = t(".fixed-action-btn")),
        ...
        return (
          _createClass(d, [
              ...
              value: function () {
                ...
                this.$dragTarget.on("click", function () {
                  ...
                  this.$dragTarget.on("touchstart", function (e) {
                    (t.lastTouchVelocity.x.startPosition =
                      e.touches[0].clientX),
                      (t.lastTouchVelocity.x.startTime = Date.now());
                  }),
                  this.$dragTarget.on(
                    "touchmove",
              ...
              value: function (t) {
                if ("touchmove" === t.type) {
                  ...
                  Date.now() - this.lastTouchVelocity.x.startTime > 20 &&
                    ((this.lastTouchVelocity.x.startPosition = e.clientX),
              ...
              value: function (t) {
                if ("left" === this.options.edge) {
                  ...
                  (this.menuOut = e),
                    this.$menu.css(
                      "transform",
                      "translateX(".concat(t - this.options.MENU_WIDTH, "px)")
                    );
                } else {
                  ...
                  n < 0 && (n = 0),
                    this.$menu.css("transform", "translateX(".concat(n, "px)"));
                }
              },
            },
            {
              ...
              value: function (t) {
                ...
                (e =
                  "left" === this.options.edge
                    ...
                    : Math.abs(
                        (t - window.innerWidth) / this.options.MENU_WIDTH
                      )),
              ...
              value: function (t) {
                if ("touchend" === t.type) {
                  ...
                  (this.lastTouchVelocity.x.endTime = Date.now()),
                    (this.lastTouchVelocity.x.endPosition = e.clientX);
              ...
              value: function () {
                ...
                this.$element.on("click", function (i) {
                  if ((i.preventDefault(), !0 === e.menuOut)) e.removeMenu();
                    ...
                    (e.menuOut = !0),
                      !0 === e.options.showOverlay
                        ? t("#sidenav-overlay").length ||
                          ((e.$sidenavOverlay = t(
                            '<div id="sidenav-overlay"></div>'
                          )),
                    ...
                    (n =
                      "left" === e.options.edge
                        ? [0, -1 * e.options.MENU_WIDTH]
                        : [0, e.options.MENU_WIDTH]),
                      "matrix(1, 0, 0, 1, 0, 0)" !== e.$menu.css("transform") &&
                        e.$menu.velocity(
                          { translateX: n },
                          {
                      ...
                      e.$sidenavOverlay.on(
                        "touchmove",
                        e.touchmoveEventHandler.bind(e)
                      ),
                      e.$menu.on("touchmove", function (t) {
                        t.preventDefault(),
                          e.$menu
                ...
                "left" === this.options.edge
                  ...
                  this.$menu.hasClass("fixed") &&
                    ...
                    t(window).resize(function () {
                      if (window.innerWidth > e.options.breakpoint)
                        e.$sidenavOverlay.length
                          ? e.removeMenu(!0)
            ...
            },
            {
              key: "setMenuWidth",
              value: function () {
                var i = t("#".concat(this.$menu.attr("id"))).find(
                  "> .sidenav-bg"
                );
                this.options.MENU_WIDTH !== e &&
  ...
  $(function (t) {
    t("#toggle").click(function () {
      t("#slide-out").hasClass("slim")
        ? (t("#slide-out").removeClass("slim"),
          t(".sv-slim-icon")
            .removeClass("fa-angle-double-right")
            .addClass("fa-angle-double-left"),
          t(".fixed-sn .double-nav").css({
        ...
        : (t("#slide-out").addClass("slim"),
          t(".sv-slim-icon")
            .removeClass("fa-angle-double-left")
            .addClass("fa-angle-double-right"),
          t(".fixed-sn .double-nav").css("padding-left", "4.6rem"),
          t(".fixed-sn main").css("padding-left", "3.7rem"),
          t(".fixed-sn footer").css("padding-left", "3.7rem"));
    });
  }),
  (function (t) {
            ...
            e.scaleColor || e.trackColor
              ? o.getImageData && o.putImageData
                ? i
                  ...
                  : (c(), (i = o.getImageData(0, 0, e.size * a, e.size * a)))
                : (this.clear(), c())
              : this.clear(),
              (o.lineCap = e.lineCap),
              (n =
    ...
    _createClass(t, [
      {
        ...
        value: function () {
          ...
          this.view.$nativeSelect
            ...
            $("ul#select-options-".concat(t)).remove();
        },
      },
      {
        key: "render",
      ...
      },
      {
        ...
        value: function () {
          if (this.view.options.placeholder)
            ...
            var t = this.view.$materialSelectInitialOption
              .replace(/"/g, "&quot;")
              .replace(/  +/g, " ")
              .trim();
      ...
      },
      {
        ...
        value: function () {
          (this.view.$materialSelect.val() || this.view.options.placeholder) &&
            ...
            this.view.$mainLabel[this.isDisabled ? "addClass" : "removeClass"](
              "disabled"
            ),
      ...
      },
      {
        ...
        value: function () {
          var t = this.view.options.visibleOptions,
            e = 0;
          ...
          var i = this.view.$materialOptionsList.find("li").not(".disabled"),
            ...
            o = i.length;
          if (
            (this.isSearchable && (e += this.view.$searchInput.height()),
            this.isMultiple && (e += this.view.$toggleAll.height()),
      ...
      },
      {
        ...
        value: function () {
          ...
          (this.view.$searchInput = $(
            ...
            this.view.$searchInput.on("click", function (t) {
      ...
      },
      {
        ...
        value: function () {
          ...
          this.view.$nativeSelectChildren.each(function (e, i) {
            var n = $(i);
            if (n.is("option"))
              t.buildSingleOption(n, t.isMultiple ? "multiple" : "");
              ...
              t.view.$materialOptionsList.append(o),
                n.children("option").each(function (e, i) {
      ...
      },
      {
        ...
        value: function () {
          ...
          t.hasClass("disabled") && t.find("input").prop("disabled")
            ? t.after(this.view.$toggleAll)
      ...
      },
      {
        ...
        value: function () {
          var t = this.view.$searchInput.find("input").val(),
            e = $(
              '<option value="'
                .concat(t.toLowerCase(), '" selected>')
                .concat(t, "</option>")
            ).prop("selected", !0);
          this.isMultiple ||
            this.view.$nativeSelectChildren.each(function (t, e) {
              $(e).attr("selected", !1);
            }),
      ...
      },
      {
        ...
        value: function (t, e) {
          var i = t.is(":disabled") ? "disabled" : "",
            ...
            c = t.attr("class"),
            u = a
              ? '<img alt="" src="'.concat(a, '" class="').concat(c, '">')
              : "",
            d = this.isMultiple
  ...
  function t(e, i) {
    ...
    _classCallCheck(this, t),
      ...
      (this.$materialSelectInitialOption =
        ...
        e.find("option:first").text() ||
        ""),
      (this.$nativeSelectChildren =
        this.$nativeSelect.children("option, optgroup")),
      (this.$materialSelect = $(
    ...
    _createClass(
      ...
      [
          ...
          value: function () {
            ...
            this.$materialSelect.on("focus", function (e) {
              ...
              if (
                ...
                !t.$materialOptionsList.is(":visible"))
              ) {
                i.trigger("open", ["focus"]);
                var n = i.val(),
                  o = t.$materialOptionsList
                    .find("li")
                    .filter(function () {
        ...
        },
        {
          ...
          value: function () {
            ...
            this.$materialSelect.on("blur", function (e) {
              var i = $(e);
              t.isMultiple || t.isSearchable || i.trigger("close"),
          ...
          value: function (t) {
            ...
            this.$toggleAll.on("click", function (i) {
              ...
              $(n).prop("checked", !o),
                ...
                e.$nativeSelect.data("stop-refresh", !0),
                e._triggerChangeOnNativeSelect(),
                e.$nativeSelect.removeData("stop-refresh"),
                i.stopPropagation();
            });
          },
        },
        {
          ...
          value: function () {
            ...
            this.$materialOptionsList.on("mousedown", function (e) {
              var i = e.target;
              $(".modal-content").find(t.$materialOptionsList).length &&
                ...
                $(n).on("click", function (o) {
                  ...
                  if (!a.hasClass("disabled") && !a.hasClass("optgroup")) {
                    ...
                    if (e.isMultiple) {
                      ...
                      e._isToggleAllPresent() && e._updateToggleAllOption(),
                        e.$materialSelect.trigger("focus");
                    } else
                      e.$materialOptionsList
                        .find("li")
                        .removeClass("active")
                    ...
                    a.attr("aria-selected", "true" === c ? "false" : "true"),
                      e._selectSingleOption(a),
                      e.$nativeSelect.data("stop-refresh", !0),
                      e.$nativeSelect.find("option").eq(i).prop("selected", r),
                      e.$nativeSelect.removeData("stop-refresh"),
                      e._triggerChangeOnNativeSelect(),
                      e.$materialSelect.val() &&
                        e.$mainLabel.addClass("active"),
                      a.hasClass("li-added") &&
                        e.renderer.buildSingleOption(a, "");
                  }
                });
              });
          },
          ...
          value: function () {
            ...
            this.$searchInput.find(".search").on("keyup", function (e) {
              var i = $(e.target),
                ...
                r = a && e.shiftKey,
                s = e.which === t.keyCodes.arrowUp;
              if (e.which === t.keyCodes.arrowDown || n || o || s)
                return (
                  t.$materialSelect.focus(),
                  void t._handleArrowUpDownKey(e.which)
                );
              var l = i.closest("ul"),
                c = i.val(),
              ...
              if (
                (u.each(function () {
                  ...
                  if ("string" == typeof this.outerHTML) {
                    ...
                    e.includes(c.toLowerCase())
                      ? t.show().parent().show()
                      : t.hide().parent().hide(),
                      e.trim() === c.toLowerCase() && (d = !0);
                  }
                }),
                a)
              )
                return t.isEditable && !d
                  ? void t.renderer.addNewOption()
                  : (r && t._handleEnterWithShiftKey(i),
                    void t.$materialSelect.trigger("open"));
              t.$addOptionBtn[c && t.isEditable && !d ? "show" : "hide"](),
                0 !==
                u.filter(function (t, e) {
                  return (
                    $(e).is(":visible") && !$(e).parent().hasClass("disabled")
                  );
                }).length
                  ? (t.$toggleAll.show(),
                    t.$materialOptionsList
                      .find(t.$noSearchResultsInfo)
                      .remove(),
                    t._updateToggleAllOption())
                  : (t.$toggleAll.hide(),
                    t.$materialOptionsList.append(t.$noSearchResultsInfo)),
                t.dropdown.updatePosition(
                  t.$materialSelect,
                  t.$materialOptionsList
                );
            });
        ...
        },
        {
          ...
          value: function () {
            ...
            $("html").on("click", function (e) {
              $(e.target).closest("#select-options-".concat(t.properties.id))
                .length ||
                $(e.target).hasClass("mdb-select") ||
                !$("#select-options-".concat(t.properties.id)).hasClass(
                  "active"
                ) ||
                (t.$materialSelect.trigger("close"),
                ...
                t.isSearchable &&
                  null !== t.$searchInput &&
                  t.$materialOptionsList.hasClass("active") &&
                  t.$materialOptionsList
        ...
        },
        {
          ...
          value: function () {
            var t = this.$materialOptionsList
                .find("li")
        ...
        },
        {
          ...
          value: function (t) {
            this.$materialOptionsList
              ...
              .trigger("click")
              .addClass("active"),
              this.isMultiple || t.trigger("close");
          },
        },
        {
          ...
          value: function (t) {
            ...
            if (t === this.keyCodes.arrowUp) {
              ...
              (s = c),
                i.each(function (t, n) {
                  $(n).hasClass(e.options.keyboardActiveClass) &&
                    ((c = i.eq(t - 1)), (s = i.eq(t)));
                }),
                (r = l.is(n) || !a ? l : c);
            } else {
          ...
          value: function (t) {
            ...
            if ((this._removeKeyboardActiveClass(), this.isSearchable)) {
              var i = t.which > 46 && t.which < 91,
                ...
                o = 8 === t.which;
              (i || n) && this.$searchInput.find("input").val(t.key).focus(),
        ...
        },
        {
          ...
          value: function () {
            ...
            t.length
              ? this.$materialOptionsList.scrollTo(t)
...
jQuery(function (t) {
    ...
    i = (function () {
      function e(t) {
        ...
        _classCallCheck(this, e),
          ...
          (this.uuid =
            t.attr("id") || this.options.selectId || this._randomUUID()),
          (this.view = new MaterialSelectView(t, {
          ...
          [
              ...
              value: function () {
                ...
                this.options.destroy
                  ...
                  : (this.isInitialized && this.view.destroy(),
                    this.view.render(),
                    this.view.selectPreselectedOptions(function (e) {
            ...
            },
            {
              ...
              value: function () {
                ...
                this.bindMutationObserverChange(),
                  ...
                  this.view.bindToggleAllClick(function (e) {
                    return t._toggleSelectedValue(e);
                  }),
                  this.view.bindMaterialOptionMousedown(),
                  this.view.bindMaterialOptionClick(function (e) {
                    return t._toggleSelectedValue(e);
                  }),
            ...
            },
            {
              ...
              value: function () {
                ...
                t.observe(this.view.$nativeSelect.get(0), {
                  ...
                  (t.customId = this.uuid),
                  (t.customStatus = "observing"),
                  e.clearMutationObservers(),
                  e.mutationObservers.push(t);
              },
            },
            {
              ...
              value: function (i) {
                i.forEach(function (i) {
                  ...
                  !0 !== n.data("stop-refresh") &&
                    ("childList" === i.type ||
                      ("attributes" === i.type && t(i.target).is("option"))) &&
                    (e.clearMutationObservers(),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  i
                    ? this.selectedOptionsIndexes.splice(e, 1)
                    : this.selectedOptionsIndexes.push(t),
                  this.view.$nativeSelect
                    .find("option")
                    .eq(t)
                    .prop("selected", !i),
                  ...
                  0 ===
                    (e =
                      ...
                      i > this.options.maxSelectedOptions
                        ...
                        : e.substring(2)).length &&
                    (e = this.view.$nativeSelect
  ...
  (function (t) {
    ...
    function a(e, n, c, d) {
      ...
      var h = !1,
        ...
        y = (b.prototype = {
          ...
          start: function () {
            return p && p.start
              ...
              : ((p.methods = {}),
                ...
                (y.component = new c(y, f)),
                (y.$root = t(
                  '<div class="' + m.picker + '" id="' + e.id + '_root" />'
                )),
                l(y.$root[0], "hidden", !0),
                (y.$holder = t(x()).appendTo(y.$root)),
                w(),
                f.formatSubmit &&
                  (function () {
                    var i;
                    ...
                    (y._hidden = t(
                      '<input type=hidden name="' +
                        i +
                        '"' +
                        (v.data("value") || e.value
                          ? ' value="' + y.get("select", f.formatSubmit) + '"'
                          : "") +
                        ">"
                    )[0]),
                      v.on("change." + p.id, function () {
                        y._hidden.value = e.value
                          ? y.get("select", f.formatSubmit)
                          : "";
                      });
                  })(),
                (function () {
                ...
                f.containerHidden
                  ? t(f.containerHidden).append(y._hidden)
                  : v.after(y._hidden),
                f.container ? t(f.container).append(y.$root) : v.after(y.$root),
                y
                  .on({
          ...
          render: function (e) {
            return (
              e
                ? ((y.$holder = t(x())), w(), y.$root.html(y.$holder))
                : y.$root.find("." + m.box).html(y.component.nodes(p.open)),
              y.trigger("render")
            );
          },
          stop: function () {
                    ...
                    i
                      ...
                      .on("keydown." + p.id, function (i) {
                        ...
                        27 == n
                          ? y.close(!0)
                          : r != y.$holder[0] || (!o && 13 != n)
                          ? t.contains(y.$root[0], r) &&
                            13 == n &&
                            (i.preventDefault(), r.click())
                          : (i.preventDefault(),
                            o
                              ? a._.trigger(y.component.key.go, y, [
                                  a._.trigger(o),
                                ])
                              : y.$root
                                  .find("." + m.highlighted)
                                  .hasClass(m.disabled) ||
                                (y.set("select", y.component.item.highlight),
          ...
          set: function (e, i, n) {
            ...
            if (((n = r && t.isPlainObject(i) ? i : n || {}), e)) {
              for (o in (r || (s[e] = i), s))
                (a = s[o]),
                  o in y.component.item &&
                    (void 0 === a && (a = null), y.component.set(o, a, n)),
                  ("select" != o && "clear" != o) ||
                    !f.updateInput ||
                    v
                      .val("clear" == o ? "" : y.get(o, f.format))
                      .trigger("change");
              y.render();
            }
          ...
          get: function (t, i) {
            ...
            if (t in y.component.item) {
              if ("string" == typeof i) {
                ...
                return n
                  ? a._.trigger(y.component.formats.toString, y.component, [
                      i,
                      n,
                    ])
                  : "";
      ...
      function x() {
        return a._.node(
          ...
          a._.node(
            ...
            a._.node(
              "div",
              a._.node("div", y.component.nodes(p.open), m.box),
              m.wrap
            ),
            m.frame
          ),
          ...
          .on({
            ...
            "mousedown click": function (i) {
              ...
              n != y.$holder[0] &&
                (i.stopPropagation(),
                "mousedown" != i.type ||
                  t(n).is("input, select, textarea, button, option") ||
                  (i.preventDefault(), y.$holder.eq(0).focus()));
            },
          })
          .on(
            "click",
            ...
            function () {
              ...
              (o = o && (o.type || o.href ? o : null)),
                (n || (o && !t.contains(y.$root[0], o))) &&
                  y.$holder.eq(0).focus(),
                !n && i.nav
                  ? y.set("highlight", y.component.item.highlight, {
                      nav: i.nav,
                    })
                  : !n && "pick" in i
      ...
      function C(t) {
        ...
        (32 == e || i || (!p.open && y.component.key[e])) &&
          (t.preventDefault(),
          t.stopPropagation(),
    ...
    function r() {
      ...
      var i = t('<div style="visibility:hidden;width:100px" />').appendTo(
          "body"
        ),
        o = i[0].offsetWidth;
    ...
    function s(t, e) {
      ...
      return (
        t.path && (i = t.path),
        t.originalEvent && t.originalEvent.path && (i = t.originalEvent.path),
        i && i.length > 0 ? (e && i.indexOf(e) >= 0 ? e : i[0]) : t.target
      );
    }
    function l(e, i, n) {
      if (t.isPlainObject(i)) for (var o in i) c(e, o, i[o]);
      else c(e, i, n);
    }
    function c(t, e, i) {
    ...
    return (
      ...
      (a._ = {
        group: function (t) {
          for (
            var e, i = "", n = a._.trigger(t.min, t);
            n <= a._.trigger(t.max, t, [n]);
            n += t.i
          )
  ...
  (function (t) {
    ...
    (o.prototype.set = function (t, e, i) {
      ...
      (o.prototype.measure = function (t, e) {
        return (
          n.isInteger(e)
            ? (e = this.now(t, e, { rel: e }))
            : e
            ? "string" == typeof e && (e = this.parse(t, e))
            : (e = "min" == t ? -1 / 0 : 1 / 0),
          e
        );
      }),
      ...
      (o.prototype.validate = function (t, i, o) {
        ...
        if (
          ...
          ((!h && c.disabled(i)) ||
            (h && c.disabled(i) && (m || a || r)) ||
            (!h && (i.pick <= p.pick || i.pick >= f.pick)))
        )
          for (
            h && !m && ((!r && d > 0) || (!a && d < 0)) && (d *= -1);
            c.disabled(i) &&
      ...
      (o.prototype.disabled = function (t) {
        ...
        return (
          ...
          -1 === i.item.enable
            ? !o
            : o || t.pick < i.item.min.pick || t.pick > i.item.max.pick
        );
      }),
        ...
        return {
          ...
          toString: function (t, e) {
            ...
            return i.formats
              ...
              .map(function (t) {
                return (
                  n.trigger(i.formats[t], i, [0, e]) || t.replace(/^!/, "")
                );
              })
              .join("");
          },
      ...
      (o.prototype.nodes = function (t) {
        var e,
          ...
          p = r.max,
          f =
            ((e = (a.showWeekdaysFull ? a.weekdaysFull : a.weekdaysShort).slice(
              0
            )),
          ...
          m = function (t) {
            return n.node(
              ...
              "data-nav=" +
                ...
                ' title="' +
                (t ? a.labelMonthNext : a.labelMonthPrev) +
                '"'
            );
          },
          v = function () {
            ...
            f +
              n.node(
                ...
                n.group({
                  ...
                  item: function (t) {
                    var e =
                      a.firstDay && 0 === o.create([u.year, u.month, 1]).day
                        ? -7
                        : 0;
                    return [
                      n.group({
  ...
  (function () {
    var t,
      ...
      s =
        "SVGAngle" in window &&
        (((e = document.createElement("div")).innerHTML = "<svg/>"),
    ...
    function M(t, e) {
      ...
      if (
        ...
        e.ampmclickable
          ...
          : (n(
              ...
              .on("click", function () {
                (D.amOrPm = "AM"),
                  D.amPmBlock.children(".pm-button").removeClass("active"),
                  D.amPmBlock.children(".am-button").addClass("active"),
                  D.spanAmPm.empty().append("AM");
              })
            ...
            n(
              ...
              .on("click", function () {
                (D.amOrPm = "PM"),
                  D.amPmBlock.children(".am-button").removeClass("active"),
                  D.amPmBlock.children(".pm-button").addClass("active"),
                  D.spanAmPm.empty().append("PM");
              })
              .appendTo(this.amPmBlock));
      }
      e.darktheme && r.addClass("darktheme"),
        ...
        P.on("click.clockpicker", m(n.proxy(this.show, this), 100));
      var E,
        L,
        $,
        F,
        ...
        if (!i || !(f < y - w || f > y + w)) {
          ...
          s && l.append(D.canvas),
            ...
            a.off(d).on(d, function (t) {
              ...
              (m || i !== u || n !== p) && ((m = !0), D.setHand(i, n, !1, !0));
            }),
    ...
    (M.DEFAULTS = {
        ...
        if (!this.isShown) {
          ...
          this.input.blur(),
            ...
            a.on(
              ...
              m(function (t) {
                var i = n(t.target);
                0 === i.closest(e.popover.find(".picker__wrap")).length &&
                  0 === i.closest(e.input).length &&
                  e.hide();
              }, 100)
            ),
            a.on(
      ...
      (M.prototype.toggleView = function (t, e) {
        ...
        "minutes" === t &&
          ...
          (T(this.options.beforeHourSelect), (i = !0));
        var o = "hours" === t,
      ...
      (M.prototype.done = function () {
        ...
        this.isHTML5 &&
          this.options.twelvehour &&
          (this.hours < 12 && "PM" === this.amOrPm && (e += 12),
      ...
      (M.prototype.remove = function () {
        this.element.removeData("clockpicker"),
          ...
          this.isAppended &&
            (o.off("resize.clockpicker" + this.id), this.popover.remove());
      }),
  ...
  (function (t, e) {
    ...
    return function (t, e, i, n) {
        ...
        detectFeatures: function () {
          ...
          if (
            ...
            var r = n.match(/Android\s([0-9\.]*)/),
              s = r ? r[1] : 0;
            (s = parseFloat(s)) >= 1 &&
              (4.4 > s && (i.isOldAndroid = !0), (i.androidVersion = s)),
      ...
      var s,
        ...
        It = function (t, e, i, n, o) {
          (!yt || (o && o !== a.currItem)) &&
            ...
            (t[O] = b + e + "px, " + i + "px" + y + " scale(" + n + ")");
        },
        Ot = function (t) {
          tt &&
            (t &&
              (v > a.currItem.fitRatio
                ? yt || (Ke(a.currItem, !1, !0), (yt = !0))
                : yt && (Ke(a.currItem), (yt = !1))),
            It(tt, ut.x, ut.y, v));
        },
        Pt = function (t) {
          t.container &&
        ...
        Dt = function (t, e) {
          if (!r.loop && e) {
            var i = u + (ft.x * ht - t) / ft.x,
              n = Math.round(t - ce.x);
            ((0 > i && n > 0) || (i >= Ne() - 1 && 0 > n)) &&
              (t = ce.x + n * r.mainScrollEndFriction);
          }
          (ce.x = t), At(t, d);
        },
        _t = function (t, e) {
        ...
        Nt = function (t, e, i, n) {
          return n === a.currItem.initialZoomLevel
            ? ((i[t] = a.currItem.initialPosition[t]), !0)
            : ((i[t] = _t(t, n)),
              i[t] > e.min[t]
                ? ((i[t] = e.min[t]), !0)
        ...
        Yt = 0,
        qt = function (t) {
          jt[t] && (jt[t].raf && _(jt[t].raf), Yt--, delete jt[t]);
        },
        Xt = function (t) {
        ...
        Qt = {
          ...
          panTo: function (t, e, i) {
            i ||
              (t > J.min.x ? (t = J.min.x) : t < J.max.x && (t = J.max.x),
            ...
            if (0 !== mt) {
              ...
              if (!(t && 2 > i)) {
                (a.currItem = Ve(u)),
                  (yt = !1),
                  St("beforeChange", mt),
                  i >= 3 && ((h += mt + (mt > 0 ? -3 : 3)), (i = 3));
                for (var n = 0; i > n; n++)
                  mt > 0
                    ? ((e = k.shift()),
                      (k[2] = e),
                      At((++h + 2) * ft.x, e.el.style),
                      a.setContent(e, u - i + n + 1 + 1))
                    : ((e = k.pop()),
                      k.unshift(e),
                      At(--h * ft.x, e.el.style),
                      a.setContent(e, u + i - n - 1 - 1));
                if (tt && 1 === Math.abs(mt)) {
                  var o = Ve(C);
          ...
          updateSize: function (e) {
            if (!vt && r.modal) {
              ...
              if (
                ...
                !e && bt.x === window.innerWidth && bt.y === window.innerHeight)
              )
                return;
              (bt.x = window.innerWidth),
                (bt.y = window.innerHeight),
                (t.style.height = bt.y + "px");
            }
            if (
              ((dt.x = a.scrollWrap.clientWidth),
              ...
              for (var n, s, l, c = 0; 3 > c; c++)
                (n = k[c]),
                  ...
                  s && s.container && (Ye(s, dt), Ke(s), Pt(s));
              w = !1;
            }
            (g = v = a.currItem.initialZoomLevel),
              (J = a.currItem.bounds) &&
                ((ut.x = J.center.x), (ut.y = J.center.y), Ot(!0)),
              St("resize");
          },
        ...
        ge = function (t, e) {
          return (
            (ve.prevent = !me(t.target, r.isClickableElement)),
        ...
        Se = function (t) {
          ...
          return (
            P
              ...
              ? t.touches &&
                t.touches.length > 0 &&
                ((Ce[0] = be(t.touches[0], we)),
                t.touches.length > 1 && (Ce[1] = be(t.touches[1], ke)))
              : ((we.x = t.pageX),
                (we.y = t.pageY),
                (we.id = ""),
                (Ce[0] = we)),
          ...
          return (
            ...
            "x" !== t)
              ? void (
                  et ||
                  K ||
                  (v > a.currItem.fitRatio && (ut[t] += e[t] * i))
                )
              : (void 0 !== s && (Dt(s, !0), (K = s !== ne.x)),
                J.min.x !== J.max.x &&
                  (void 0 !== o ? (ut.x = o) : K || (ut.x += e.x * i)),
                void 0 !== s)
          );
        },
        Te = function (t) {
              ...
              if (
                ...
                i >
                  a.currItem.initialZoomLevel +
                    a.currItem.initialZoomLevel / 15 && (rt = !0);
                var n = 1,
                  o = Wt(),
                  s = Vt();
                if (o > i)
                ...
                if (
                  (nt &&
                    ((nt = !1),
                    Math.abs(Jt.x) >= 10 && (Jt.x -= Q[0].x - ee.x),
                    Math.abs(Jt.y) >= 10 && (Jt.y -= Q[0].y - ee.y)),
                  (te.x = Zt.x),
                  (te.y = Zt.y),
                  0 === Jt.x && 0 === Jt.y)
                )
                ...
                if (
                  ...
                  (lt.y += Jt.y), (ut.y += Jt.y);
                  var c = xe();
                  return (H = !0), St("onVerticalDrag", c), Tt(c), void Ot();
                }
                (function (t, e, i) {
                  if (t - V > 50) {
        ...
        Pe = function (t) {
          ...
          if (
            ...
            if ((Ut(), N || (N = Ae()), N.calculateSwipeSpeed("x"), H))
              ...
              if (!et)
                return "swipe" !== n
                  ? void Le()
                  : void (!K && v > a.currItem.fitRatio && De(N));
            }
        },
        Ae = function () {
          var t,
            ...
            i = {
              ...
              calculateOverBoundsAnimOffset: function (t, e) {
                i.backAnimStarted[t] ||
                  (ut[t] > J.min[t]
                    ? (i.backAnimDestination[t] = J.min[t])
                    : ut[t] < J.max[t] && (i.backAnimDestination[t] = J.max[t]),
              ...
              panAnimLoop: function () {
                return jt.zoomPan &&
                  ((jt.zoomPan.raf = D(i.panAnimLoop)),
                  (i.now = Mt()),
          ...
          return (
            ...
            Math.abs(t.lastFlickSpeed.y) <= 0.05
              ? ((t.speedDecelerationRatioAbs.x =
                ...
                !0)
              : (Xt("zoomPan"), (t.lastNow = Mt()), void t.panAnimLoop())
          );
        },
        _e = function (t, e) {
          var i, n, s;
          if ((et || (re = u), "swipe" === t)) {
            ...
            l > 30 && (c || e.lastFlickOffset.x > 20)
              ? (n = -1)
              : -30 > l && (c || e.lastFlickOffset.x < -20) && (n = 1);
          }
          n &&
            (0 > (u += n)
              ? ((u = r.loop ? Ne() - 1 : 0), (s = !0))
              : u >= Ne() && ((u = r.loop ? 0 : Ne() - 1), (s = !0)),
            (!s || r.loop) && ((mt += n), (ht -= n), (i = !0)));
          var d,
            h = ft.x * ht,
            p = Math.abs(h - ce.x);
          return (
            i || h > ce.x == e.lastFlickSpeed.x > 0
              ? ((d =
            ...
            Kt("mainScroll", ce.x, h, d, o.easing.cubic.out, Dt, function () {
              Ut(),
                (et = !1),
                (re = -1),
          ...
          initGestures: function () {
            ...
            (P = R.pointerEvent) && R.touch && (R.touch = !1),
              P
                ...
                : R.touch
                ? (t("touch", "start", "move", "end", "cancel"), (A = !0))
      ...
      var $e,
              ...
              ($e = setTimeout(
                function () {
                  if ((St("initialZoom" + (n ? "Out" : "In")), n)) {
                    ...
                    i
                      ? Kt("initialZoom", 0, 1, d, o.easing.cubic.out, p, h)
                      : (p(1), ($e = setTimeout(h, d + 20)));
                  } else
                    (v = e.initialZoomLevel),
                      Et(ut, e.initialPosition),
                      Ot(),
                      Tt(1),
                      s ? (t.style.opacity = 1) : Tt(1),
                      ($e = setTimeout(h, d + 20));
                },
                n ? 25 : 90
              ));
        ...
        Ue = function (t, e) {
          return t.src && t.loadError && t.container
        ...
        Qe = function () {
          if (Be.length) {
            for (var t, e = 0; e < Be.length; e++)
              (t = Be[e]).holder.index === t.index &&
                qe(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
            Be = [];
          }
        };
      xt("Controller", {
        publicMethods: {
          ...
          initController: function () {
            o.extend(r, je, !0),
              ...
              Ct("mainScrollAnimComplete", Qe),
              Ct("initialZoomInEnd", Qe),
              Ct("destroy", function () {
          ...
          setContent: function (t, e) {
            ...
            if (l) {
              ...
              Re || e !== u ? Pt(l) : ((tt = c.style), ze(l, n || l.img)),
                (t.el.innerHTML = ""),
                t.el.appendChild(c);
            } else t.el.innerHTML = "";
          },
          ...
          publicMethods: {
            ...
            handleMouseWheel: function (t) {
              if (v <= a.currItem.fitRatio)
                return (
                  r.modal &&
                    (!r.closeOnScroll || Yt || j
                      ? t.preventDefault()
                      : O && Math.abs(t.deltaY) > 2 && ((c = !0), a.close())),
                  !0
                );
              if ((t.stopPropagation(), (Ge.x = 0), "deltaX" in t))
                1 === t.deltaMode
                  ? ((Ge.x = 18 * t.deltaX), (Ge.y = 18 * t.deltaY))
                  : ((Ge.x = t.deltaX), (Ge.y = t.deltaY));
              else if ("wheelDelta" in t)
                t.wheelDeltaX && (Ge.x = -0.16 * t.wheelDeltaX),
                  t.wheelDeltaY
                    ? (Ge.y = -0.16 * t.wheelDeltaY)
                    : (Ge.y = -0.16 * t.wheelDelta);
              else {
          ...
          initHistory: function () {
            if ((o.extend(r, pi, !0), r.history)) {
              (di = window.location),
                ...
                si.indexOf("gid=") > -1 &&
                  (si = (si = si.split("&gid=")[0]).split("?gid=")[0]),
  ...
  (function (t, e) {
    ...
    return function (t, e) {
      var i,
        ...
        M = function (t) {
          if (g) return !0;
          (t = t || window.event), v.timeToIdle && v.mouseUsed && !u && $();
          for (
            var i,
              n,
        ...
        _ = function () {
          for (var t, e, i, n, o = "", a = 0; a < v.shareButtons.length; a++)
            (t = v.shareButtons[a]),
              (e = v.getImageURLForShare(t)),
              (i = v.getPageURLForShare(t)),
              (n = v.getTextForShare(t)),
              (o +=
                '<a href="' +
                t.url
        ...
        L = 0,
        $ = function () {
          clearTimeout(y), (L = 0), u && x.setIdle(!1);
        },
        F = function (t) {
        ...
        e.extend(t.options, S, !0),
          ...
          (function () {
            ...
            d("onVerticalDrag", function (t) {
              k && 0.95 > t
                ? x.hideControls()
                : !k && t >= 0.95 && x.showControls();
            }),
              d("onPinchClose", function (e) {
                k && 0.9 > e
                  ? (x.hideControls(), (t = !0))
                  : t && !k && e > 0.9 && x.showControls();
              }),
          ...
          d("destroy", function () {
            v.captionEl &&
              (a && n.removeChild(a), e.removeClass(o, "pswp__caption--empty")),
        ...
        (x.update = function () {
          k && t.currItem
            ? (x.updateIndexIndicator(),
              v.captionEl &&
                (v.addCaptionHTMLFn(t.currItem, o),
        ...
        (x.onGlobalTap = function (i) {
          ...
          if (!g)
            if (i.detail && "mouse" === i.detail.pointerType) {
              ...
              v.tapToClose && (e.hasClass(n, "pswp__img") || E(n)))
            )
              return void t.close();
        }),
    ...
    var e = function (t) {
      ...
      i = function (t, e, i, n) {
        ...
        if (
          ((a = (function (t) {
            for (
              var e, i, n, o, a = t.childNodes, r = a.length, s = [], l = 0;
              l < r;
              l++
            )
              1 === (e = a[l]).nodeType &&
...
initPhotoSwipeFromDOM(".mdb-lightbox"),
      ...
      return this.each(function () {
        ...
        function p() {
          ...
          (u.width(f), o && "string" == typeof d) &&
            (p = t(d).offset().top - a - s);
          if (c < r) {
            if (
              (i.stickyClass && e.addClass(i.stickyClass),
              e.after(u).css({ position: "fixed", top: s, width: f }),
              n && e.css({ zIndex: l }),
              o && p < r)
            ) {
              var m = p - r + s;
          ...
          } else i.stickyClass && e.removeClass(i.stickyClass), e.css({ position: "static", top: null, left: null, width: "auto" }), u.remove();
        }
        h.innerHeight() > a &&
          (h.bind("scroll", p), h.bind("load", p), h.bind("resize", p));
      });
    };
  })(jQuery),
  (function (t, e) {
    ...
    function d(t) {
      return (
        n(t, "input,[contenteditable]") ||
        n(t, "select,[contenteditable]") ||
        n(t, "textarea,[contenteditable]") ||
        n(t, "button,[contenteditable]")
      );
    }
    function h(t, e) {
      return (
    ...
    function f(t, e) {
      ...
      function n() {
        s(t, p),
          t[f].classList.remove(v.state.clicking),
      ...
      t.event.bind(t[u], "mousedown", function (e) {
        (g = m[h]),
          ...
          t[f].classList.add(v.state.clicking),
          e.stopPropagation(),
          e.preventDefault();
      });
    }
    ...
    var w = function (t, e, i, n, o) {
        ...
        !(function (t, e, i, n, o) {
          ...
          (t.reach[u] = null),
            ...
            e &&
              (p.dispatchEvent(c("ps-scroll-" + u)),
              e < 0
                ? p.dispatchEvent(c("ps-scroll-" + d))
                : e > 0 && p.dispatchEvent(c("ps-scroll-" + h)),
              n && l(t, u)),
            t.reach[u] &&
              (e || o) &&
              p.dispatchEvent(c("ps-" + u + "-reach-" + t.reach[u]));
        })(t, i, a, n, o);
      },
      k = {
        isWebKit:
      ...
      C = function (t) {
        ...
        (t.containerWidth = e.clientWidth),
          ...
          e.contains(t.scrollbarXRail) ||
            (a(e, v.element.rail("x")).forEach(function (t) {
              return o(t);
            }),
            e.appendChild(t.scrollbarXRail)),
          e.contains(t.scrollbarYRail) ||
            (a(e, v.element.rail("y")).forEach(function (t) {
              return o(t);
            }),
      ...
      S = {
              ...
              (t.settings.suppressScrollX && 0 !== r) ||
                ...
                (function (i, n) {
                  ...
                  if (0 === i) {
                    ...
                    if (
                      (0 === o && n > 0) ||
                      (o >= t.contentHeight - t.containerHeight && n < 0)
                    )
            ...
            if (!i(t.target, a, r)) {
              ...
              e.settings.useBothWheelAxes
                ? e.scrollbarYActive && !e.scrollbarXActive
                  ? (r
                      ? (o.scrollTop -= r * e.settings.wheelSpeed)
                  ...
                  : e.scrollbarXActive &&
                    ...
                    (a
                      ...
                      : (o.scrollLeft -= r * e.settings.wheelSpeed),
                    (s = !0))
                : ((o.scrollTop -= r * e.settings.wheelSpeed),
                  (o.scrollLeft += a * e.settings.wheelSpeed)),
                C(e),
        ...
        touch: function (e) {
          function i(t, i) {
            ...
            if (r > a) {
              if (
                (i < 0 && n === e.contentHeight - e.containerHeight) ||
                (i > 0 && 0 === n)
              )
                return 0 === window.scrollY && i > 0 && k.isChrome;
            } else if (
              a > r &&
              ...
              (f = setInterval(function () {
                e.isInitialized
                  ...
                  ? Math.abs(p.x) < 0.01 && Math.abs(p.y) < 0.01
                    ? clearInterval(f)
                    : (n(30 * p.x, 30 * p.y), (p.x *= 0.8), (p.y *= 0.8))
                  : clearInterval(f);
              }, 10)));
          }
        ...
        (this.isRtl = "rtl" === t(n).direction),
          (this.isNegativeScroll = (function () {
            var t,
              e = n.scrollLeft;
            return (
              (n.scrollLeft = -1), (t = n.scrollLeft < 0), (n.scrollLeft = e), t
            );
          })()),
        ...
        _createClass(e, [
                ...
                this.chips.each(function (i, n) {
                  ...
                  if (!o.data("initialized")) {
                    ...
                    (a.data && Array.isArray(a.data)) || (a.data = []),
                      ...
                      o.attr("tabindex", 0),
                      o.hasClass(e.selectors.chips) || o.addClass("chips"),
                      e.renderChips(o);
                  }
                }),
                this.eventsHandled ||
          ...
          },
          {
            ...
            value: function () {
              this.chips.data(
                "options",
                t.extend({}, this.defaultOptions, this.options)
              );
            },
          },
          {
            ...
            value: function () {
              ...
              this.$document.on("blur", this.selectors.chips, function (i) {
                setTimeout(function () {
                  ...
                  t(i.target).removeClass("active"),
                  t(".chip.selected").removeClass("selected");
              });
            },
          },
          {
            ...
            value: function () {
              this.chips.on("click", ".chip", function () {
                t(".chip.selected").not(this).removeClass("selected"),
          ...
          },
          {
            ...
            value: function () {
              ...
              this.chips.on("keydown", function (e) {
                var i = t.$document.find(
                    t.selectors.chip + t.selectors.selectedChip
                  ),
                ...
                if (i.length) {
                  ...
                  a || r
                    ? (e.preventDefault(), t.deleteSelectedChip(n, i, o))
                    : s
                    ? t.selectLeftChip(n, i)
                    : l && t.selectRightChip(n, i, o);
                }
              });
            },
          },
          {
            ...
            value: function () {
              ...
              (i.hasClass("chips-autocomplete")
                ...
                var n = t(i.target);
                n.closest(e.selectors.chips).addClass("focus"),
          ...
          },
          {
            ...
            value: function () {
              ...
              this.chips.on("keydown", "input", function (i) {
                ...
                if ((l || c) && !e.ulWrapper.find("li").hasClass("selected"))
                  return (
                    i.preventDefault(),
                    e.addChip(r, { tag: n.val() }, a),
                    void n.val("")
                  );
                var h =
                    i.keyCode === e.keyCodes.arrowLeft ||
                    i.keyCode === e.keyCodes.delete,
                  p = "" === n.val();
                h && p && s && e.selectChip(r, s - 1, a),
                  p && t(e.selectors.input).hasClass("active")
                    ? u && e.selectChip(r, s - 1, a)
              ...
              this.chips.on("click", ".chip .fas", function (i) {
                ...
                o.parents().eq(1).hasClass("chips-autocomplete")
                  ...
                  ? o.parent().hasClass("chips-initial") &&
                    ...
                    (n = o.parents().eq(0))
                  : (n = o.parents().eq(0)),
                  e.deleteChip(n.data("index"), o.index(), n),
                  n.find("input").focus();
              });
            },
          },
          {
            ...
            value: function () {
              ...
              a.on("keyup", function (r) {
                ...
                r.which === e.keyCodes.enter && (i.empty(), i.remove()),
                  0 === s.length
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              o < i - 1 ? (a = o) : (o !== i && o !== i - 1) || (a = i - 1),
                a < 0 && (a = null),
                null !== a && this.selectChip(n, a, t),
                i || t.find("input").focus();
            },
          },
          {
            key: "selectLeftChip",
            value: function (e, i) {
              var n = i.index() - 1;
              n < 0 ||
                (t(this.selectors.chip).removeClass("selected"),
                this.selectChip(e.data("index"), n, e));
            },
          },
          {
            key: "selectRightChip",
            value: function (e, i, n) {
              ...
              t(this.selectors.chip).removeClass("selected"),
                o > n
                  ? e.find("input").focus()
                  : this.selectChip(e.data("index"), o, e);
            },
          },
          {
            key: "renderChips",
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                t.image && (e += ' <img src="'.concat(t.image, '"> ')),
                (e += '<i class="close fas fa-times"></i>'),
                (e += "</div>")
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              t.data("chips").length && e.placeholder
                ? t.find("input").prop("placeholder", e.placeholder)
                : !t.data("chips").length &&
                  e.secondaryPlaceholder &&
                  t.find("input").prop("placeholder", e.secondaryPlaceholder);
            },
          },
          {
            key: "isValid",
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              i.find(".chip").eq(e).remove(),
                i.data("chips").splice(e, 1),
              ...
              t &&
                ...
                (0, s.default)(function () {
                  t.forEach(function (t) {
                    t.target &&
                      t.target.jarallax &&
                      (m || t.target.jarallax.onResize(), (v = !0));
                  });
                });
            }),
          k = 0,
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return (
                      t &&
                        "string" == typeof t &&
                        (t = this.$item.querySelector(t)),
                      t instanceof Element || (t = null),
                      t &&
                        (this.options.keepImg
                          ? (this.image.$item = t.cloneNode(!0))
                          : ((this.image.$item = t),
                  ...
                  value: function () {
                    ...
                    if (
                      ...
                      for (
                        ...
                        r &&
                          "none" !== r &&
                          ((o = 1), (this.image.position = "absolute")),
                          (a = a.parentNode);
                      }
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if (
                      ...
                      t
                        ? this.$item.setAttribute("style", t)
                        : this.$item.removeAttribute("style"),
                      this.image.useImgTag)
                    ) {
                      var e = this.image.$item.getAttribute(
                        "data-jarallax-original-styles"
                      );
                  ...
                  value: function () {
                    ...
                    return (
                      ...
                      this.css(this.image.$item, {
                        ...
                        marginTop: r + "px",
                        left:
                          "fixed" === this.image.position ? t.left + "px" : "0",
                        width: t.width + "px",
                      }),
                  ...
                  value: function (t) {
                    ...
                    if (
                      (this.options.elementInViewport &&
                        (a =
                          this.options.elementInViewport.getBoundingClientRect()),
          ...
          S = function (t) {
            ...
            for (
              ...
              if (
                ...
                void 0 === e
                  ? t[o].jarallax || (t[o].jarallax = new C(t[o], e))
                  : t[o].jarallax &&
                    (r = t[o].jarallax[e].apply(t[o].jarallax, i)),
                void 0 !== r)
              )
                return r;
            return t;
                  ...
                  e.$video
                    ...
                    : e.onAPIready(function () {
                        ...
                        if (
                          ...
                          (e.player =
                            e.player ||
                            new window.YT.Player(e.playerID, e.playerOptions)),
                            a &&
                          ...
                          e.$video ||
                            ...
                            Object.keys(e.videoID).forEach(function (t) {
                              ...
                              (i = e.$video),
                                (n = e.videoID[t]),
                                (o = "video/" + t),
                                ((a = document.createElement("source")).src =
                                  n),
                                (a.type = o),
                                i.appendChild(a);
                            })),
                ...
                value: function () {
                  if (!s || !l) {
                    ...
                    if (
                      ("youtube" !== this.type ||
                        s ||
                        ((s = 1), (t = "https://www.youtube.com/iframe_api")),
                      "vimeo" !== this.type ||
                        l ||
                        ((l = 1),
                  ...
                  if (
                    ...
                    if ("undefined" != typeof Vimeo || u)
                      ...
                      var e = setInterval(function () {
                        "undefined" != typeof Vimeo &&
                          (clearInterval(e), h.resolve("done"), t());
                      }, 20);
                    }
                  "local" === this.type && t();
                },
        ...
        (e.default = function () {
          ...
          e.prototype.initImg = function () {
            ...
            return (
              ...
              this.options.videoSrc ? ((this.defaultInitImgResult = t), !0) : t
            );
          };
            ...
            },
            {
              ...
              value: function () {
                ...
                this.$input.on("focus", function () {
                  t.$input.css("border-bottom", t.options.inputFocus),
                    t.$input.css("box-shadow", t.options.inputFocusShadow);
                });
              },
            },
            {
              ...
              value: function () {
                ...
                this.$input.on("blur", function () {
                  t.$input.css("border-bottom", t.options.inputBlur),
                    t.$input.css("box-shadow", t.options.inputBlurShadow);
                });
              },
            },
            {
                ...
                this.$input.on("keyup", function (i) {
                  ...
                  if ((e.$autocompleteWrap.empty(), n.length)) {
                    for (var o in e.options.data)
                      if (
                        -1 !==
                        e.options.data[o].toLowerCase().indexOf(n.toLowerCase())
                      ) {
                    ...
                    if (40 === i.which) {
                      if (c > s.length - 2)
                        return (c = -1), s.scrollTop(0), void (u = -45);
                      c++,
                        (u += l),
                        r.scrollTop(u),
    ...
    t("body").on("shown.bs.modal", ".modal", function () {
      t(".modal-backdrop").length ||
        ...
        $modal_dialog.hasClass("modal-side") &&
          (t(this).addClass("modal-scrolling"),
          t("body").addClass("scrollable")),
        $modal_dialog.hasClass("modal-frame") &&
          (t(this).addClass("modal-content-clickable"),
          t("body").addClass("scrollable")));
    }),
  ...
  (function (t, e) {
    ...
    function s() {
      for (
        var e = [].slice
            .call(this.querySelectorAll(t.INPUT))
            .filter(function (t) {
    ...
    return {
      init: function (i, n) {
        ...
        for (
          ...
          Object.defineProperty(h, "bsCustomFileInput", {
            value: { defaultText: e(h) },
            writable: !0,
          }),
            r.call(h),
            h.addEventListener(c, r);
        }
        for (var p = 0, f = a.length; p < f; p++)
          a[p].addEventListener(l, s),
            Object.defineProperty(a[p], "bsCustomFileInput", {
              value: !0,
              writable: !0,
            });
      },
      destroy: function () {
        for (
          var e = [].slice
              .call(document.querySelectorAll(t.FORM))
              .filter(function (t) {
                return !!t.bsCustomFileInput;
              }),
            i = [].slice
              .call(document.querySelectorAll(t.INPUT))
              .filter(function (t) {
                return !!t.bsCustomFileInput;
              }),
            o = 0,
        ...
        for (var d = 0, h = e.length; d < h; d++)
          e[d].removeEventListener(l, s), (e[d].bsCustomFileInput = void 0);
      },
    };
  }),
